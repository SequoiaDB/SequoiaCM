...
public class OverWriteTask extends S3ImportTask {

    private static final Logger logger = LoggerFactory.getLogger(OverWriteTask.class);

    public OverWriteTask(S3ImportObject s3ImportObject, String destBucket) {
    ...
    public void doTask() throws ScmToolsException {
        ...
        try {
            ...
            logger.error("Overwrite object failed, bucket={}, dest_bucket={}, key={}",
