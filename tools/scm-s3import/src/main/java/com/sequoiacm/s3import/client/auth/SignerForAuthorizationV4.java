package com.sequoiacm.s3import.client.auth;
...
public class SignerForAuthorizationV4 extends SignerBase {
    ...
    public SignerForAuthorizationV4(URL endpointUrl, String httpMethod, String serviceName,
            String regionName) {
    ...
    public String computeSignature(Map<String, String> headers, Map<String, String> queryParameters,
        ...
        String signatureAuthorizationHeader = "Signature=" + CommonUtils.toHex(signature);
