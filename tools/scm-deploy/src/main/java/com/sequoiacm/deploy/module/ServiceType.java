...
public enum ServiceType {
    ...
    SERVICE_TRACE("service-trace", false, InstallPackType.CLOUD, 1),
    AUTH_SERVER("auth-server", true, InstallPackType.CLOUD, 2),
    MQ_SERVER("mq-server", false, InstallPackType.MQ_SERVER, 2),
    CONFIG_SERVER("config-server", true, InstallPackType.CONFIG_SERVER, 3),
