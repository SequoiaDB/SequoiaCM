...
@Deployer
public class AuthServerDeployer extends ServiceDeployerBase {

    private ScmPasswordFileSender pwdFileSender = ScmPasswordFileSender.getInstance();

    public AuthServerDeployer() {
        super(ServiceType.AUTH_SERVER);
    }
    ...
    protected BSONObject decorateTemplateDeployJson(BSONObject templateBson, NodeInfo node) throws Exception {
        ...
        return new BasicBSONObject().append(DeployJsonDefine.AUTH_SERVER, decoratedArray)
