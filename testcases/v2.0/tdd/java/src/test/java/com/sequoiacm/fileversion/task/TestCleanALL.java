...
public class TestCleanALL extends ScmTestMultiCenterBase {
    ...
    private ScmFile f1;
    private ScmFile f2;
    private static final Logger logger = LoggerFactory.getLogger(TestCleanALL.class);
    ...
    public void test() throws ScmException, InterruptedException, IOException {
        ...
        checkCleanedFile(f1Current, file1Version2File);
