...
public class TestCreateNewVersionByBreakpointFile extends ScmTestMultiCenterBase {
    ...
    private void clearEnv() throws ScmException {
        ...
        try {
            ScmFactory.BreakpointFile.deleteInstance(ws, this.getClass().getSimpleName());
        }
        catch (Exception e) {
            // ignore
        }
    ...
    public void test() throws ScmException {
        ...
        ScmBreakpointFile b = ScmFactory.BreakpointFile.createInstance(ws, "version2File");
        b.upload(new File(version2File));
