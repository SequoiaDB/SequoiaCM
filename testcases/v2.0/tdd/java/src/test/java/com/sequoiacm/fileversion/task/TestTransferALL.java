...
public class TestTransferALL extends ScmTestMultiCenterBase {
    ...
    private static final Logger logger = LoggerFactory.getLogger(TestTransferALL.class);
    ...
    public void test() throws ScmException, InterruptedException, IOException {
        ...
        Assert.assertEquals(taskInfo.getEstimateCount(), 2, taskInfo.toString());
        Assert.assertEquals(taskInfo.getActualCount(), 2, taskInfo.toString());
        Assert.assertEquals(taskInfo.getSuccessCount(), 2, taskInfo.toString());
        ...
        checkTransferedFile(f1Current, file1Version2File);
    ...
    private void checkTransferedFile(ScmFile file, String srcFielData) throws IOException, ScmException {
