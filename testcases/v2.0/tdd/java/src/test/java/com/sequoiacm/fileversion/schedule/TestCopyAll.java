...
public class TestCopyAll extends ScmTestMultiCenterBase {
    ...
    private static final Logger logger = LoggerFactory.getLogger(TestCopyAll.class);
    ...
    public void test() throws ScmException, InterruptedException, IOException {
        ...
        ScmScheduleContent content = new ScmScheduleCopyFileContent(site2.getName(),
                ...
                .is(f1.getFileId().get()).get(), ScopeType.SCOPE_ALL);
        String cron = "* * * * * ?";
        ...
        waitFileBeCopy(f1.getFileId(), 2, 0);
