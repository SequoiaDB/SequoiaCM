 ...
 *
 */
public class WriteBPFileAndFileWithCreateDate extends ScmTestMultiCenterBase {
    private static final Logger logger = Logger.getLogger(WriteBPFileAndFileWithCreateDate.class);
    ...
    public void getFile() throws ScmException, IOException, ParseException {
        ...
        logger.info("fileId=" + id.get() + ",fileCreateTime=" + file.getCreateTime().getTime()
