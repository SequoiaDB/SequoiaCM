...
public class TestCleanCurrent extends ScmTestMultiCenterBase {
    ...
    private ScmFile f1;
    private ScmFile f2;
    private static final Logger logger = LoggerFactory.getLogger(TestCleanCurrent.class);
    ...
    public void test() throws ScmException, InterruptedException, IOException {
        ...
        checkOthreFile(f1History, file1Version1File);
