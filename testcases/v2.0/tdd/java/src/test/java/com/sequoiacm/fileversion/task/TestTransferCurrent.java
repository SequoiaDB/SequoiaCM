...
public class TestTransferCurrent extends ScmTestMultiCenterBase {
    ...
    private static final Logger logger = LoggerFactory.getLogger(TestTransferCurrent.class);
    ...
    public void test() throws ScmException, InterruptedException, IOException {
        ...
        ScmId taskId = ScmSystem.Task
                .startTransferTask(wsB,
                        ...
                        .is(this.getClass().getSimpleName() + "1").get(),
        ...
        ScmFile f1History = ScmFactory.File.getInstance(wsM, f1.getFileId(), 2, 0);
        ...
        Assert.assertEquals(ScmTestTools.getMD5(downFile), ScmTestTools.getMD5(file1Version2File));

        ScmFile f1Current = ScmFactory.File.getInstance(wsM, f1.getFileId(), 1, 0);
