...
/**
 * @description SCM-1371:指定文件校验断点续传文件，其中源文件已更新 SCM-3929:指定文件校验断点续传文件，其中源文件已更新
 * @author wuyan
...
public class BreakpointFile1371_3929 extends TestScmBase {
    ...
    private int updateSize = 1024 * 1024 * 5;
