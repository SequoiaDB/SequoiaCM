...
/**
 * @descreption SCM-3908:并发执行迁移和清理任务，迁移源、目标站点，清理站点都不相同，操作相同文件
 * @author YiPan
 * @date 2021/10/27
 * @updateUser
 * @updateDate
 ...
 * @version 1.0
 */
public class ConcurrentTasks3908 extends TestScmBase {
    private static final String fileName = "file3908";
    ...
    public void test() throws Exception {
        ...
        // 校验文件元数据
        SiteWrapper[] expSite = { rootSite, branchSite2 };
