...
/**
 * @description SCM-4335:上传多个分段存在partNum为1、连续分段号且分段长度一致
 * @author ZhangYanan
 ...
 * @version v1.0
 */
public class MultipartUpload4335 extends TestScmBase {
    private boolean runSuccess = false;
    private String keyName = "/aa/object4335";
    private String bucketName = "bucket4335";
