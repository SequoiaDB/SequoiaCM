...
/**
 * @Description: SCM-3028 :: 工作区索引状态为none或者deleting,工作区删除索引
 * @author fanyu
 * @Date:2020/11/12
 * @version:1.0
 */
public class FullText3028 extends TestScmBase {
    private boolean runSuccess = false;
    private SiteWrapper site = null;
    private ScmSession session = null;
    private String wsName = null;
    private ScmWorkspace ws = null;
    private String fileNameBase = "file3028_";
