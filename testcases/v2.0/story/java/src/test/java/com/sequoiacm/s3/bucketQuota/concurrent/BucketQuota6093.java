...
/**
 * @description SCM-6093:获取桶限额信息与删除对象并发
 * @author ZhangYanan
...
public class BucketQuota6093 extends TestScmBase {
    private boolean runSuccess = false;
    private String keyName = "object6093";
    private String bucketName = "bucket6093";
