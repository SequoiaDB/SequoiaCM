...
/**
 * @Description SCM-3584:指定ifNoneMatch和ifModifiedSince条件匹配源对象复制
 * @author fanyu
 * @Date 2019.09.17
 */
public class CopyObject3584 extends TestScmBase {
    private boolean runSuccess = false;
    private AmazonS3 s3Client = null;
    private String srcBucketName = "bucket3584a";
    private String dstBucketName = "bucket3584b";
    private String keyName = "obj3584";
