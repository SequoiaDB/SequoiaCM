 ...
 * @version:1.0
 */
public class AuthDir_UpdateRead1726 extends TestScmBase {
    ...
    private String username = "AuthDir_UpdateRead1726";
    private String rolename = "Role_1726_UR";
    private String passwd = "1726";
    private ScmUser user;
    private ScmRole role;
    private ScmResource rs1;
    private ScmResource rs2;
    private String basepath = "/AuthDir_UpdateRead1726";
	...
	try {
	    ...
	    // check
	    ScmFile actfile = ScmFactory.File.getInstanceByPath(wsUR, newpath + "/" + fileName);
	...
	try {
	    ...
	    rs1 = ScmResourceFactory.createDirectoryResource(wsp.getName(), path);
	    rs2 = ScmResourceFactory.createDirectoryResource(wsp.getName(), path1);
	    createDir(wsA, path);
	    createDir(wsA, path1);
