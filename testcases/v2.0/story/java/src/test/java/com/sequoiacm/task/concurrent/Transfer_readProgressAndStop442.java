...
public class Transfer_readProgressAndStop442 extends TestScmBase {
	...
	private void test() {
		try {
			StopTaskAndReadProgressThread TaskThreadM = new StopTaskAndReadProgressThread(rootSite);
			StopTaskAndReadProgressThread TaskThreadA = new StopTaskAndReadProgressThread(branceSiteList.get(0));
			StopTaskAndReadProgressThread TaskThreadB = new StopTaskAndReadProgressThread(branceSiteList.get(1));
