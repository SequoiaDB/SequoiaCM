...
/**
 * @Description SCM-3703:更新调度任务优先region中存在符合条件节点，zone中不存在符合条件节点
 * @Author zhangyanan
 * @Date 2021.8.28
 ...
 * @version 1.00
 */
public class CreateSchedule3703 extends TestScmBase {
    private int fileSize = 1024 * 100;
    private File localPath = null;
    private String filePath = null;
    private String fileName = "file3703";
    private String region;
    private String zone;
    private static String updateZone = "zone3";
    ...
    public void test() throws Exception {
        ...
        ScmScheduleUtils.checkNodeRegion( lastesSuccessTasks, rootSiteSession,
                region );
        runSuccess = true;
    }
