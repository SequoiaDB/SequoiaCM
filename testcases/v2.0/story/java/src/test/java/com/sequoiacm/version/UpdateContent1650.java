...
/**
 * test content:update Content of  the current scm file from siteA,than download the updatefile from siteB
...
public class UpdateContent1650 extends TestScmBase {
	...
	private void test() throws Exception {
		...
		SiteWrapper[] expSiteList = { branSites.get(0), branSites.get(1),ScmInfo.getRootSite()};
