...
/**
 * @description SCM-4445:指定有效的源文件桶名，复制分段上传
 * @author ZhangYanan
 ...
 * @version v1.0
 */
public class MultipartUpload4445 extends TestScmBase {
    private boolean runSuccess = false;
    private AmazonS3 s3Client;
    private String targetBucketName = "targetbucket4445";
    private String sourceBucketName = "sourcebucket4445";
    private String targetKey = "/aa/bb/targetobj4445";
    private String sourceKey = "/aa/bb/sourceobj4445";
    ...
    public void test() throws Exception {
        ...
        // 目标桶名和源桶名相同
        uploadPartCopy( sourceBucketName, sourceKey, sourceBucketName,
                targetKey );
        runSuccess = true;
    }
