...
public class Object4266_4267 extends TestScmBase {
    ...
    private String fileName = "file4266";
    ...
    public void test() throws Exception {
        ...
        // 清理、创建文件
        fileIds = cleanAndCreateFile( fileId );
        ...
        Assert.assertTrue( s3Client.doesObjectExist( bucketName, fileName ) );
        runSuccess = true;
    }

    private List< ScmId > cleanAndCreateFile( ScmId fileId )
            throws ScmException {
