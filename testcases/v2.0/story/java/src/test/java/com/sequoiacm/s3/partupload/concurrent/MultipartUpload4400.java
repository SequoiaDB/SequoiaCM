...
/**
 * @description SCM-4400:相同key并发初始化上传对象
 * @author ZhangYanan
...
public class MultipartUpload4400 extends TestScmBase {
    private boolean runSuccess = false;
    private String bucketName = "bucket4400";
    private String keyName = "key4400";
    ...
    public void testUpload() throws Exception {
        ...
        es.addWorker( new ThreadUploadPart4400( 6 * 1024 * 1024, file ) );
        es.addWorker( new ThreadUploadPart4400( 6 * 1024 * 1024, file2 ) );
        es.addWorker( new ThreadUploadPart4400( 5 * 1024 * 1024, file ) );
        es.run();
    ...
    class ThreadUploadPart4400 {
        ...
        public ThreadUploadPart4400(long partSize, File file )
                throws Exception {
