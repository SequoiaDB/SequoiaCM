...
public class WsFlow2212 extends TestScmBase {
	...
	private void setUp() throws Exception {
		...
		try {
			...
			ScmWorkspaceUtil.createWS(session, wsNames[2], ScmInfo.getSiteNum());
	...
	private void test() throws Exception {
		...
		ScmWorkspace ws = ScmFactory.Workspace.getWorkspace(wsNames[0], session);
		...
		ScmWorkspace ws2 = ScmFactory.Workspace.getWorkspace(wsNames[2], sessionA);
		ScmId fileId1 = ScmFileUtils.create(ws2, name + "_" + UUID.randomUUID(), filePath);
		// check
		...
		ScmWorkspace ws1 = ScmFactory.Workspace.getWorkspace(wsNames[1], session);
		ScmId fileId2 = ScmFileUtils.create(ws1, name + "_" + UUID.randomUUID(), filePath);
