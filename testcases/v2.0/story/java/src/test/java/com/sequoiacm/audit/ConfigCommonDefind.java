...
public class ConfigCommonDefind {
    ...
    public static class  Permission {
        //the type of int
        public static final String ribbon_maxAutoRetries = "ribbon.MaxAutoRetries";
        public static final String ribbon_maxAutoRetriesNextServer = "ribbon.MaxAutoRetriesNextServer";
        public static final String ribbon_connectTimeout = "ribbon.ConnectTimeout";
        ...
        //the type of boolean
        public static final String prefer_same_zone_eureka = "eureka.client.prefer-same-zone-eureka";
        public static final String zipkin_enabled = "spring.zipkin.enabled";
        public static final String hystrix_timeout_enabled = "hystrix.command.default.execution.timeout.enabled";
        public static final String ribbon_retry = "ribbon.OkToRetryOnAllOperations";
    ...
    public static class Forbidden {
        ...
        public static final String register_with_eureka = "eureka.client.register-with-eureka";
        public static final String fetch_registry = "eureka.client.fetch-registry";
        public static final String metadata_map_region = "eureka.instance.metadata-map.region";
