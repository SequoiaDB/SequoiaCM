 ...
 * @version:1.0
 */
public class AuthDir_NoCreateRead1726 extends TestScmBase {
    private SiteWrapper site;
    private ScmSession sessionA;
    private ScmSession sessionCR;
    private ScmWorkspace wsA;
    private ScmWorkspace wsCR;
    private String username = "AuthDir_NoCreateRead1726";
    private String rolename = "Role_1726_NCR";
    private String passwd = "1726";
    private ScmUser user;
    private ScmRole role;
    private ScmResource rs;
    private String basepath = "/AuthDir_NoCreateRead1726";
    private String path = basepath + "/1726_A/1726_B/1726_C";
    private String author = "AuthDir_NoCreateRead1726";
    ...
    private void testCreateDir() {
        ...
        try {
            ScmFactory.Directory.createInstance( wsCR, subpath );
    ...
    private void testCreateFileInDir() throws ScmException {
        ...
        try {
            // create dir
            dir = ScmFactory.Directory.createInstance( wsCR, subpath );
    ...
    private void prepare() throws Exception {
        try {
            ...
            ScmAuthUtils.checkPriority( site, username, passwd, role,
                    wsp.getName() );
            sessionCR = ScmSessionUtils.createSession( site, username, passwd );
