...
/**
 * @descreption SCM-4680 :: 禁用版本控制，带versionId删除最新版本对象
 * @author Zhaoyujing
 * @Date 2020/7/13
 * @updateUser
 * @updateDate
 ...
 * @version 1.0
 */
public class Object4680 extends TestScmBase {
    private String bucketName = "bucket4680";
    private String keyName = "testKey4680";
    private List< S3VersionSummary > expVersionList = new ArrayList<>();
    private int oneObjVersionNum = 3;
    private String fileContent = "content4680";
