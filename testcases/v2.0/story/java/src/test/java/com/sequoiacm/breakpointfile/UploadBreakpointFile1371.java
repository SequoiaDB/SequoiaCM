...
/**
* test content:modify the contents of uploaded files, then breakpoint continuation file 
...
public class UploadBreakpointFile1371 extends TestScmBase {
	...
	private void createBreakpointFile() throws ScmException, IOException {
		...
		breakpointFile.incrementalUpload(new ByteArrayInputStream(updateData), false);		
	}		
