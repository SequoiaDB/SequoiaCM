...
public class CreateMutiDir1133 extends TestScmBase {
	...
	private String fullPath1 = dirBasePath + "/1133_a/1133_b/1133_c/1133_e/1133_f";
	private String fullPath2 = dirBasePath + "_1/1133_x/1133_x/1133_x/1133_x/1133_x";
	...
	private void check(ScmDirectory dir,BSONObject cond){
		try {
		    ...
		    Assert.assertEquals(dir.getParentDirectory().getName(), cond.get("paName"));
