...
/**
 * @Description SCM-4049:创建时指定BreakponitFileType = DIRECTED，断点续传文件
 * @Author zhangyanan
 * @Date 2021.11.5
...
public class BreakpointFile4049 extends TestScmBase {
    private static SiteWrapper site = null;
    private static WsWrapper wsp = null;
    private static ScmSession session = null;
    private ScmWorkspace ws = null;
    private ScmId fileId = null;
    private String uploadFileName = "uploadBreakpointfile4049_";
    private String uploadFailedFileName = "uploadFailedBreakpointfile4049_";
