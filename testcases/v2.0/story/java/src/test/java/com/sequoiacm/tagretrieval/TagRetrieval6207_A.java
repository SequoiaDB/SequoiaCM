...
// * (原 SCM-1612:更新已存在标签 SCM-1613:更新添加新的标签)
// * @Author yangjianbo
...
// * @Version 1.0
// */
//public class TagRetrieval6207_A extends TestScmBase {
...
//
//    private String name = "defineTags6207_A";
...
//        Assert.assertTrue( fileTags.toSet().contains( "k1" ),
//                fileTags.toString() );
...
//        Assert.assertTrue( batchTags.toSet().contains( "k1" ),
//                fileTags.toString() );
//        Assert.assertTrue( batchTags.toSet().contains( "k2" ),
//                fileTags.toString() );
//    }
//
//    // SCM-1613:更新添加新的标签
