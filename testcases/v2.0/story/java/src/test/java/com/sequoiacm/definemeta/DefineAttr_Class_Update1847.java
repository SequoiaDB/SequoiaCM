...
public class DefineAttr_Class_Update1847 extends TestScmBase {
    ...
    private void tearDown() {
        try {
            ScmFactory.Role.revokePrivilege(session, role, wsrs, ScmPrivilegeType.ALL);
    ...
    private void check(ScmClass actClass, ScmClass expClass) {
        ...
        Assert.assertEquals(actClass.getWorkspace().getName(), expClass.getWorkspace().getName());
        ...
        Assert.assertEquals(actClass.getUpdateTime().compareTo(expClass.getUpdateTime()), 1);
    }
