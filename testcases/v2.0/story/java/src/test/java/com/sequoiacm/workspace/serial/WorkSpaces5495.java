...
/**
 * @descreption SCM-5495:修改数据源分区规则与桶内文件下载验证
 * @author ZhangYanan
 * @date 2022/11/29
 * @updateUser
 * @updateDate
 ...
 * @version 1.0
 */
public class WorkSpaces5495 extends TestScmBase {
    private ScmSession session = null;
    private SiteWrapper site = null;
    private String wsName = "ws5495";
    private String key1 = "key5495a";
    private String key2 = "key5495b";
    private String bucketName = "bucket5495";
    ...
    public void test() throws Exception {
        ...
        checkFileData( key1, filePath1 );

        file = bucket.createFile( key2 );
        file.setContent( filePath2 );
        file.save();
        checkFileData( key2, filePath2 );
        runSuccess = true;
    }
    ...
    private void checkFileData( String key, String filePath ) throws Exception {
