...
public class Audit2339 extends TestScmBase {
    ...
    private void checkAudit( String username, String password,
            boolean isLogged1, boolean isLogged2, boolean isLogged3 )
            throws ScmException {
        ScmId metaId = null;
        ScmId fileId = null;
        try {
            ...
            BSONObject bson1 = new BasicBSONObject()
                    .append( ScmAttributeName.Audit.TYPE, "CREATE_META_CLASS" )
                    .append( ScmAttributeName.Audit.USERNAME, username );
            BSONObject bson2 = new BasicBSONObject()
                    .append( ScmAttributeName.Audit.TYPE, "META_CLASS_DQL" )
                    .append( ScmAttributeName.Audit.USERNAME, username );
    ...
    private ScmId createAndQueryMeta( String username, String metaName )
            throws ScmException {
