...
public class DelAndUpSche1268 extends TestScmBase {
    ...
    private void setUp() {
        try {
            ...
            ScmScheduleUtils.isRunningOfSche( ssA, scheIds.get( 0 ),
                    CommonDefine.TaskType.SCM_TASK_TRANSFER_FILE );
            ScmScheduleUtils.isRunningOfSche( ssA1, scheIds.get( 1 ),
                    CommonDefine.TaskType.SCM_TASK_TRANSFER_FILE );
        } catch ( Exception e ) {
            e.printStackTrace();
    ...
    private void test() throws Exception {
        ...
        ScmScheduleUtils.checkScmFile( wsA1, fileIds, fileNum / 2, fileNum,
                expSites2 );
    ...
    private void tearDown() throws Exception {
        if ( !runSuccess ) {
            ...
            ScmScheduleUtils.outputScmfileInfo( wsA1,
    ...
    private void createSchedule( String wsName, SiteWrapper branSite,
            SiteWrapper rootSite ) throws ScmException {
