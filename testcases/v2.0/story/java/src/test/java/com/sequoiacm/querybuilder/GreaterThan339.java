...
/**
 * @Testcase: SCM-339:greaterThan单个字段
 * @author huangxiaoni init
 * @date 2017.5.25
 */

public class GreaterThan339 extends TestScmBase {
	...
	private String fileName = "GreaterThan339";
	...
	private void testQuery() throws Exception {
		try {
			...
			BSONObject cond = ScmQueryBuilder.start(key).greaterThan(value).put(ScmAttributeName.File.AUTHOR)
					.is(file.getAuthor()).get();

			String expCond = "{ \"" + key + "\" : { \"$gt\" : " + value + "}" + " , \"author\" : \"" + author + "\"}";
