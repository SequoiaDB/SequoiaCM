...
public class ReadOnDataNoExist1095 extends TestScmBase {
    ...
    private void setUp() throws Exception {
        ...
        wsp = ScmInfo.getWs();
        sessionA = ScmSessionUtils.createSession( siteList.get( 0 ) );
        sessionB = ScmSessionUtils.createSession( siteList.get( 1 ) );
    ...
    private void test() throws Exception {
        ...
        deleteDataAndRead( siteList1, siteList.get( 0 ), wsp,
                fileIdList.get( 0 ) );
        ...
        deleteDataAndRead( siteList2, siteList.get( 0 ), wsp,
                fileIdList.get( 1 ) );
