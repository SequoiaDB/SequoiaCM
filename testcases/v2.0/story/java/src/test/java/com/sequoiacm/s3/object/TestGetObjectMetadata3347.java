...
/**
 * @Descreption SCM-3347:带prefix、start-after、delimiter匹配查询对象元数据列表
 * @Author YiPan
 * @Date 2021/2/26
 */
public class TestGetObjectMetadata3347 extends TestScmBase {
    private AmazonS3 s3Client = null;
    private String bucketName = "bucket3347";
    private String objectName = "object3347";
    private int objectnum = 3;
    ...
    public void test() throws IOException {
        ...
        for ( int i = 0; i < objectnum; i++ ) {
            ...
            expperfix.add( prefix + i + delimiter );
