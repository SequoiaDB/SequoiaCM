...
/**
 * @descreption SCM-5602:修改数据源分区规则后，目标站点存在相同lob，迁移清理文件
 * @author ZhangYanan
 * @date 2022/11/29
 * @updateUser
 * @updateDate
 ...
 * @version 1.0
 */
public class WorkSpaces5602 extends TestScmBase {
    private ScmSession session = null;
    private SiteWrapper rootSite = null;
    private SiteWrapper branSite = null;
    private String wsName = "ws5602";
    private String fileName = "file5602";
