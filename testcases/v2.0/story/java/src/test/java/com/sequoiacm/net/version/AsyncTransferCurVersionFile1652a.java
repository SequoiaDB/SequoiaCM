...
/**
 * test content:update Content of the current scm file, than ayncTransfer the current version file 
...
public class AsyncTransferCurVersionFile1652a extends TestScmBase {
	...
	private String fileName = "fileVersion1652a";
	...
	private void asyncTransferCurrentVersionFile(int majorVersion) throws Exception {
		...
		// wait task finished
		int sitenums = 2;
		VersionUtils.waitAsyncTaskFinished(wsA, fileId, majorVersion, sitenums);
	}
