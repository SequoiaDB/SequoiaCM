...
/**
 * @Description SCM-4836 :: 获取历史版本文件更新属性
 * @author wuyan
 * @Date 2022.07.14
 * @version 1.00
 */
public class ScmFile4836 extends TestScmBase {
    private boolean runSuccess = false;
    private String bucketName = "bucket4836";
    private String fileName = "scmfile4836";
    private ScmId fileId = null;
    private ScmId batchId = null;
    private SiteWrapper site = null;
    private int fileSize = 1024 * 8;
    ...
    public void test() throws Exception {
        String newAuthor = "newscmfile4836";
        String newtitle = "jim4836";
        ...
        // 获取当前版本属性信息
        ScmFile file2 = scmBucket.getFile( fileName, currentVersion, 0 );
