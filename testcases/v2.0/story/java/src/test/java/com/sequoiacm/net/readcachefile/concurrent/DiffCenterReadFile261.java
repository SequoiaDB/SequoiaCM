...
public class DiffCenterReadFile261 extends TestScmBase {
    ...
    //TODO: BUG:SEQUOIACM-412，由于bug单未修改，用例里面暂时捕获-411 -401异常避免用例失败
    ...
    private class ReadFileFromM extends TestThreadBase {
        ...
        public void exec() throws Exception {
            ...
            try {
                ...
                if (e.getError() != ScmError.DATA_IS_IN_USE && e.getError() != ScmError.DATA_NOT_EXIST
    ...
    private class ReadFileFromA extends TestThreadBase {
        ...
        public void exec() throws Exception {
            ...
            try {
                ...
                if (e.getError() != ScmError.DATA_NOT_EXIST && e.getError() != ScmError.DATA_IS_IN_USE  &&
                        e.getError() != ScmError. DATA_ERROR) {
                    throw e;
                }
            } finally {
