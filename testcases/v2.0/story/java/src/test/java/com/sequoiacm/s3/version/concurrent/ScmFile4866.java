...
/**
 * @descreption SCM-4866 :: 禁用版本控制，并发更新属性和更新版本文件
 * @author Zhaoyujing
 * @Date 2020/7/21
 * @updateUser
 * @updateDate
 ...
 * @version 1.0
 */
public class ScmFile4866 extends TestScmBase {
    private ScmSession session = null;
    private ScmWorkspace ws = null;
    private boolean runSuccess = false;
    private String bucketName = "bucket4866";
    private String keyName = "aa/bb/object4866";
    private int fileSize = 1024 * 10;
    private int updateSize = 1024 * 20;
    private File localPath = null;
    private String filePath = null;
    private String updatePath = null;
    private String updateTile = "title4866-1";
    ...
    public void test() throws Exception {
        ...
        te.addWorker( new UpdateContentThread() );
        te.addWorker( new UpdateMetaThread() );
        te.run();
    ...
    private void checkFile( String bucketName, String objectName, String path )
        ...
        Assert.assertEquals( file.getTitle(), updateTile);
    }

    private class UpdateContentThread extends ResultStore {
        @ExecuteOrder(step = 1)
    ...
    private class UpdateMetaThread extends ResultStore {
        @ExecuteOrder(step = 1)
        public void run() throws Exception {
            ScmBucket bucket = ScmFactory.Bucket.getBucket( session,
                    bucketName );
            ScmFile file = bucket.getFile( keyName );
            file.setTitle( updateTile );
        }
    }
}
