...
public class IsExistDir2255 extends TestScmBase {
	...
	private void test() throws ScmException {
		//create directory
		ScmDirectory dir = ScmFactory.Directory.createInstance(ws, dirBasePath);
		...
		boolean flag = ScmFactory.Directory.isInstanceExist(ws,dirBasePath + name);
		...
		boolean flag1 = ScmFactory.Directory.isInstanceExist(ws, dirBasePath + name);
