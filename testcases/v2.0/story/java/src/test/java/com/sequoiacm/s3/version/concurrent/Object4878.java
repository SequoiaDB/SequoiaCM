...
/**
 * @descreption SCM-4878 :: 开启版本控制，并发更新和删除相同文件
 * @author Zhaoyujing
 * @Date 2020/7/23
 * @updateUser
 * @updateDate
 ...
 * @version 1.0
 */
public class Object4878 extends TestScmBase {
    private AmazonS3 s3Client = null;
    private ScmSession session = null;
    private ScmWorkspace ws = null;
    private boolean runSuccess = false;
    private String bucketName = "bucket4878";
    private String keyName = "aa/bb/object4878";
    ...
    private void checkFileList() throws ScmException {
    ...
    private class PutObjectThread extends ResultStore {
        @ExecuteOrder(step = 1)
        public void run() throws Exception {
            s3Client.putObject( bucketName, keyName, "content4878");
        }
    }
}
