...
/**
 * @Description SCM-4787 :: 桶开启版本控制，获取文件执行非物理删除
 * @author wuyan
 * @Date 2022.07.12
 * @version 1.00
 */
public class ScmFile4787A extends TestScmBase {
    private boolean runSuccess = false;
    private String bucketName = "bucket4787";
    private String fileName = "scmfile4787";
