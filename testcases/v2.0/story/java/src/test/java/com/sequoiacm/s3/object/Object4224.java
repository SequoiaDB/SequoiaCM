...
/**
 * @Descreption SCM-4224:S3接口创建S3文件，SCM API查询文件
 * @Author YiPan
 ...
 * @Version
 */
public class Object4224 extends TestScmBase {
    private final String bucketName = "bucket4224";
    ...
    public void setUp() throws Exception {
        ...
        s3Client = S3Utils.buildS3Client( rootSite.getSiteName() );
    ...
    public void test() throws Exception {
        ...
        ScmFile file = bucket.getFile( objectKey );

        // 元数据校验
        Assert.assertEquals( file.getFileName(), objectKey );
