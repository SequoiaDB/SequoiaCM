...
/**
 * @Descreption SCM-5280:工作区配置不缓存策略，使用seek读跨站点读文件
 * @Author YiPan
 * @CreateDate
 * @UpdateUser
 ...
 * @Version
 */
public class AcrossCenterReadFile5280 extends TestScmBase {
    private final String fileNameBase = "file5280_";
    private final String fileAuthor = "author5280";
