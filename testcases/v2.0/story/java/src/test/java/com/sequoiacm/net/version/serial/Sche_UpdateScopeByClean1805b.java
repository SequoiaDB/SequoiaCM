...
public class Sche_UpdateScopeByClean1805b extends TestScmBase {
	...
	private void test() throws Exception {
		...
		SiteWrapper[] expCurSiteList_b = { lastSite };
		VersionUtils.checkScheTaskFileSites(wsA, fileIdList, currentVersion, expCurSiteList_b);
		SiteWrapper[] exphHisSiteList_b = { lastSite, cleanSite };
		VersionUtils.checkScheTaskFileSites(wsL, fileIdList, historyVersion, exphHisSiteList_b);
		...
		// test b: check siteinfo
		SiteWrapper[] expCurSiteList_c = { lastSite };
		VersionUtils.checkScheTaskFileSites(wsA, fileIdList, currentVersion, expCurSiteList_c);
		SiteWrapper[] exphHisSiteList_c = { lastSite };
		VersionUtils.checkScheTaskFileSites(wsL, fileIdList, historyVersion, exphHisSiteList_c);
		runSuccess = true;
	}
