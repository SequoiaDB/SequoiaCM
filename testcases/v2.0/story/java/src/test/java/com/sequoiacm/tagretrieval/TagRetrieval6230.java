...
//
///**
// * @Descreption SCM-6230:使用or组合多个not_contains检索文件
// * @Author YiPan
...
// * @Version
// */
//public class TagRetrieval6230 extends TestScmBase {
//    private String fileNameBase = "file6230_";
//    private String fileAuthor = "author6230";
//    private String wsName = "ws6230";
...
//        // 1. 字符串标签不包含abc or 自由标签不包含abc=vABC的文件
...
//
//        // 2. 字符串标签不包含*a* or 自由标签不包含abc=vabc的文件
...
//        TagRetrievalUtils.checkSearchFileList( scmCursor, expFileList );
//
//        // 3.字符串标签不包含*a* or 自由标签不包含tag1=*a*的文件
//        tagCondition = ScmTagConditionBuilder.builder().tags()
//                .notContains( "*a*", true, true ).build();
//        customTagCondition = ScmTagConditionBuilder.builder().customTag()
