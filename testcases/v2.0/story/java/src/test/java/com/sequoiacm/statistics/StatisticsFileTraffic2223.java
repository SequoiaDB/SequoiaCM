...
/**
 * test content: statistics download file traffic,only test the traffic of the day
	...
	private void createFiles( ScmWorkspace ws, int fileNums) throws ScmException{	
		...
		for ( int i = 0; i < fileNums; i++ ){
			...
			if( i < 10){
				...
				fileId = StatisticsUtils.createFileByStream( ws, subfileName, fileData, authorName, timestamp );
			}
			if ( i >= 10 && i < 15 ){
