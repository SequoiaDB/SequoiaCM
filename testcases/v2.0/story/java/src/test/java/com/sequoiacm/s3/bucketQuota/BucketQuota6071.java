...
/**
 * @description SCM-6071:暂停版本控制，上传对象（不存在null版本）后统计桶流量信息
 * @author ZhangYanan
...
public class BucketQuota6071 extends TestScmBase {
    private boolean runSuccess = false;
    private String keyName = "object6071";
    private String bucketName = "bucket6071";
