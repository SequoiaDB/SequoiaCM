...
public class Audit4285 extends TestScmBase {
    ...
    public void setUp() throws Exception {
        ...
        s3Client = S3Utils.buildS3Client( site.getSiteName() );
    ...
    public void test() throws Exception {
        ...
        ConfUtil.checkAuditByType( session, S3_OBJECT_DQL, "key=" + objectKey );

        // 列取对象
        s3Client.listObjects( bucketName );
        ConfUtil.checkAuditByType( session, S3_OBJECT_DQL,
                "bucket=" + bucketName );
        runSuccess = true;
    }
