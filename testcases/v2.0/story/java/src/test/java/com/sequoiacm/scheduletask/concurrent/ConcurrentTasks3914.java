...
/**
 * @description SCM-3914:迁移任务和跨中心读取文件并发，源站点相同，目标站点相同
 * @author ZhangYanan
 ...
 * @version v1.0
 */
public class ConcurrentTasks3914 extends TestScmBase {
    private String fileName = "file3914";
    ...
    public void setUp() throws Exception {
        ...
        branchSite1 = ScmScheduleUtils.getSortBranchSites().get( 0 );
    ...
    public void test() throws Exception {
        ...
        es.addWorker( new ThreadReadFile( branchSite1 ) );
        es.run();
