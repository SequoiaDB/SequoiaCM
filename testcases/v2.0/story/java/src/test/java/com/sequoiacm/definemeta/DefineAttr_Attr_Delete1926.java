...
/**
 * @Description: SCM-1926 :: 存在模型关连属性,删除属性
 * @author fanyu
 * @Date:2018年7月5日
 * @version:1.0
 */
public class DefineAttr_Attr_Delete1926 extends TestScmBase {
    private boolean runSuccess = false;
    private String attrname = "Delete1926";
    private String desc = "Delete1926";
    private ScmAttribute attr;
    private ScmClass class1;
    ...
    private void test() throws ScmException {
        ...
        try {
            ...
            if ( e.getError() != ScmError.METADATA_ATTR_DELETE_FAILED ) {
                e.printStackTrace();
                Assert.fail( e.getMessage() );
            }
        }
    ...
    private void createClass() {
        try {
            class1 = ScmFactory.Class.createInstance( ws, attrname, desc );
        } catch ( ScmException e ) {
            e.printStackTrace();
            Assert.fail( e.getMessage() );
        }
