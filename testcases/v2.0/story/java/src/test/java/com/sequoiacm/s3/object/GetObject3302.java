...
/**
 * @Descreption SCM-3302:指定ifMatch和ifUnModifiedSince条件获取对象（标准模式）
 * @Author YiPan
 * @Date 2020/3/11
 */
public class GetObject3302 extends TestScmBase {
    private boolean runSuccess = false;
    private String bucketName = "bucket3302";
    private String objectName = "object3302";
