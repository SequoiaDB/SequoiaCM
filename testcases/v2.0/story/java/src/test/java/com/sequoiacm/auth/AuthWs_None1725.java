...
/**
 * @Description:SCM-1725 :: 无接口对应工作区资源的权限，对表格中的各个接口进行覆盖测试
 * @author fanyu
 * @Date:2018年6月14日
 * @version:1.0
 */
public class AuthWs_None1725 extends TestScmBase {
    private SiteWrapper site;
    private WsWrapper wsp;
    private ScmSession sessionA;
    private ScmSession session;
    private ScmWorkspace ws;
    private String username = "AuthWsDir_None1731";
    private String passwd = "1731";
