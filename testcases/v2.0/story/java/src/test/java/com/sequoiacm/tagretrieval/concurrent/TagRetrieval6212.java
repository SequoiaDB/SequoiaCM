...
//
///**
// * @Descreption SCM-6212:并发增加单个自由标签和更新文件自由标签字段
// * @Author yangjianbo
...
// * @Version 1.0
// */
//public class TagRetrieval6212 extends TestScmBase {
//    private ScmSession session = null;
//    private SiteWrapper rootSite = null;
//    private WsWrapper wsp = null;
//    private BSONObject queryCond = null;
//    private String fileAuthor = "auth6212";
//    private int fileSize = 1024 * 1024;
//    private String filePath = null;
//    private File localPath = null;
//    private ScmWorkspace ws = null;
//    private String fileName = "file6212_";
//
...
//
//        // 启动两个并发线程，增加单个标签和更新文件标签字段，如线程a新增标签tag1=value1；线程b更新文件标签字段为[tag2=value2,tag3=value3]
...
//
//        threadExec.addWorker( new AddTag( scmId, "tag1", "value1" ) );
