...
public class GetConfProps1215 extends TestScmBase {
	...
	private void test() throws Exception {
		String response = rest.setRequestMethod(HttpMethod.GET)
				.setApi("conf-properties?keys=scm.rootsite.meta.url,scm.rootsite.meta.user,an.inexistent.key")
		...
		Assert.assertNotEquals("null", conf.getString("scm.rootsite.meta.user"));
