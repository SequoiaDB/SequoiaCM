...
public class Sche_UpdateScopeByCleanTask1805a extends TestScmBase {	
	...
	private void test() throws Exception {			
		...
		SiteWrapper[] exphHisSiteList = {  lastSite, cleanSite };;	
		...
		SiteWrapper[] exphHisSiteList1 = {  lastSite };	
		VersionUtils.checkScheTaskFileSites(wsL, fileIdList,historyVersion,exphHisSiteList1);
		runSuccess = true;
	}
	...
	private void createScheduleTask(ScmSession session) throws ScmException {
		...
		content = new ScmScheduleCleanFileContent(cleanSite.getSiteName(), maxStayTime, condition, ScopeType.SCOPE_CURRENT);
		cron = "* * * * * ?";
