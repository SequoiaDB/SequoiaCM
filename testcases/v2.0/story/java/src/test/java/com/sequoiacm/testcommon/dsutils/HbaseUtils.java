...
public class HbaseUtils extends TestScmBase {
	...
	public static Connection getConnection(SiteWrapper site) throws IOException {
	...
	public static void createNS(SiteWrapper site,String nsName) throws IOException {
		Admin admin = null;
		try {
	...
	public static void deleteNS(SiteWrapper site,String nsName) throws IOException {
		Admin admin = null;
		try {
			admin = getConnection(site).getAdmin();
			if(isExistNS(site,nsName)) {
	...
	private static boolean isExistNS(SiteWrapper site,String nsName) throws IOException {
	...
	public static boolean isInNS(SiteWrapper site,String nsName,String tablename) throws IOException {
		boolean isIn = false;
		Admin admin = null;
		try {
			admin = getConnection(site).getAdmin();
			HTableDescriptor[] tabledescs = admin.listTableDescriptorsByNamespace(nsName);
