...
//	private static final Logger logger = Logger.getLogger(DefineAttr_dateValid_1584_1585.class);
	...
	private void test_setPropIsTrue() throws Exception {
		...
		Assert.assertEquals(properties.getProperty("test_attr_name_bool_001"), true);
		Assert.assertEquals(properties.getProperty("test_attr_name_bool_002"), true);
		Assert.assertEquals(properties.getProperty("test_attr_name_bool_003"), true);
	...
	private void test_setPropIsFalse() throws Exception {
		...
		file = ScmFactory.File.getInstance(ws, fileId);
		properties = file.getClassProperties();
		Assert.assertEquals(properties.getProperty("test_attr_name_bool_001"), false);
		Assert.assertEquals(properties.getProperty("test_attr_name_bool_002"), false);
		Assert.assertEquals(properties.getProperty("test_attr_name_bool_003"), false);
