...
//
///**
// * @Descreption SCM-6217:文件并发删除单个相同字符串标签
// * @Author yangjianbo
...
// * @Version 1.0
// */
//public class TagRetrieval6217 extends TestScmBase {
//    private ScmSession session = null;
//    private SiteWrapper rootSite = null;
//    private WsWrapper wsp = null;
//    private BSONObject queryCond = null;
//    private String fileAuthor = "auth6217";
//    private int fileSize = 1024 * 1024;
//    private String filePath = null;
//    private File localPath = null;
//    private ScmWorkspace ws = null;
//    private String fileName = "file6217_";
...
//            instance.addTagV2( "tag" + i );
//            set.add( "tag" + i );
//        }
//
//        // 启动多个并发线程，并发删除单个字符串标签
//        ThreadExecutor threadExec = new ThreadExecutor();
//        for ( int i = 0; i < threadNum; i++ ) {
//            if ( i % 2 == 0 ) {
//                threadExec.addWorker( new RemoveTagV2( scmId, "tag" + i ) );
//                set.remove( "tag" + i );
//            }
//        }
//        threadExec.run();
