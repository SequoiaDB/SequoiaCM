...
public class AsyncTransfer_whenLobRemain489 extends TestScmBase {
	...
	private void test() throws Exception {
		// analog lob remain in targetSite's sdb
		TestSdbTools.Lob.putLob(targetSite, ws_T, fileId, lobPath);
		// transfer siteA's file to targetSite, expect transfer,delete residual data
