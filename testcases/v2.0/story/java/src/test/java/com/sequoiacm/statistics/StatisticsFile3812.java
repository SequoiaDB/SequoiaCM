...
/**
 * @description SCM-3812:下载文件部分成功，查询最大响应时间、最小响应时间和失败请求数
 * @author ZhangYanan
 ...
 * @version v1.0
 */
public class StatisticsFile3812 extends TestScmBase {
    private File localPath = null;
    private boolean runSuccess = false;
    private SiteWrapper site = null;
    private WsWrapper wsp = null;
    private BSONObject queryCond = null;
    private String fileName = "file3812";
    ...
    public void constructStatisticsInfo() throws Exception {
        ...
        for ( int i = fileNums - failCount; i < fileNums; i++ ) {
            StatisticsUtils.downloadFileFialed( fileIdList.get( i ),
                    siteWorkspace );
        }
    }
