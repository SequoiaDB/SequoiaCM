...
public class AuthWs_ReapteGrantPriv1743 extends TestScmBase {
    ...
    private String[] usernameArr = { "AuthWs_ReapteGrantPriv1743_0",
            "AuthWs_ReapteGrantPriv1743_1" };
    ...
    private void test1() throws Exception {
        ...
        try {
            ...
            grantPriAndAttachRole( session, rs, userList.get( 0 ),
                    roleList.get( 0 ), ScmPrivilegeType.ALL );
            grantPriAndAttachRole( session, rs, userList.get( 0 ),
                    roleList.get( 0 ), ScmPrivilegeType.ALL );
    ...
    private void test2() throws Exception {
        ...
        try {
            rs = ScmResourceFactory.createWorkspaceResource( wsp.getName() );
            grantPriAndAttachRole( session, rs, userList.get( 1 ),
                    roleList.get( 1 ), ScmPrivilegeType.CREATE );
            grantPriAndAttachRole( session, rs, userList.get( 1 ),
