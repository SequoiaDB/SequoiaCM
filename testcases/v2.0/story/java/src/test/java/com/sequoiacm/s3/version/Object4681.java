...
/**
 * @descreption SCM-4681 :: 禁用版本控制，带versionId删除历史版本对象
 * @author Zhaoyujing
 * @Date 2020/7/13
 * @updateUser
 * @updateDate
 ...
 * @version 1.0
 */
public class Object4681 extends TestScmBase {
    private String bucketName = "bucket4681";
    private String keyName = "testKey4681";
    private List< S3VersionSummary > expVersionList = new ArrayList<>();
    private int oneObjVersionNum = 3;
    private String fileContent = "content4681";
