...
public class UpdateConf2302 extends TestScmBase {
    ...
    private void test() throws Exception {
        ...
        List<ScmServiceInstance> instancesList = ScmSystem.ServiceCenter.getServiceInstanceList(session,serviceName);
        ...
        for(ScmServiceInstance instances:instancesList){
            ConfUtil.checkUpdatedConf(instances.getIp()+":"+instances.getPort(),map);
        }
        ...
        public void exec() throws Exception {
            ...
            try {
                ...
                ScmConfigProperties confProp = ScmConfigProperties.builder()
                        ...
                        .build();
               results = ScmSystem.Configuration.setConfigProperties(session, confProp);
