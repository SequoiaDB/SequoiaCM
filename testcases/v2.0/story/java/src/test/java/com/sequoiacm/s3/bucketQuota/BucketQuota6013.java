...
/**
 * @description SCM-6013:暂停版本控制后删除对象（存在null版本且不带deleteMarker），检查桶容量限额
 * @author ZhangYanan
...
public class BucketQuota6013 extends TestScmBase {
    private boolean runSuccess = false;
    private String keyName = "object6013";
    private String bucketName = "bucket6013";
    ...
    private void setUp() throws Exception {
        ...
        quotaConfig = ScmEnableBucketQuotaConfig
