...
public class AuthServer_role1519_1523_1524 extends TestScmBase {
	private static final Logger logger = Logger.getLogger(AuthServer_role1519_1523_1524.class);
	...
	private void test_createRoleByOrdinaryUser() throws ScmException {
		...
		try {
			...
			logger.info("create role by ordinary user, errorMsg = [" + e.getError() + "]");
		}
	...
	private void test_delRoleByOrdinaryUser() throws ScmException {
		...
		try {
			...
			logger.info("delete role by ordinary user, errorMsg = [" + e.getError() + "]");
		}
