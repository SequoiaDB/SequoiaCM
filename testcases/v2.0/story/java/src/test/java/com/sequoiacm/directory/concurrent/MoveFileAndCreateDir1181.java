 ...
 * @version:1.0
 */
public class MoveFileAndCreateDir1181 extends TestScmBase{
	...
	private String fullPath2 = dirBasePath + "/dir_1181/MoveFileAndCreateDir1181";
	...
	private class CreateDir extends TestThreadBase {
		public void exec() {
			try {
				...
				expBSON.put("name", "MoveFileAndCreateDir1181");
				expBSON.put("path", fullPath2 + "/");
				expBSON.put("wsName", wsp.getName());
				expBSON.put("paName", "dir_1181");
	...
	private class MoveFile extends TestThreadBase {
		public void exec() {
			try {
				...
				ScmDirectory dir = ScmFactory.Directory.getInstance(ws,dirBasePath);
