...
/**
 * @description SCM-4132:指定数据源上传文件，并发多线程使用ScmFile.getContentLocaltions()接口获取文件数据源信息
 * @author ZhangYanan
 ...
 * @version v1.0
 */
public class FileContentLocaltions4132 extends TestScmBase {
    ...
    private String fileName = "file_4132";
