...
/**
 * @description SCM-4457:并发复制分段上传，相同的源对象，不同的目标对象
 * @author ZhangYanan
 ...
 * @version v1.0
 */
public class MultipartUpload4457 extends TestScmBase {
    private boolean runSuccess = false;
    private AmazonS3 s3Client;
    private String targetBucketName1 = "targetbucket4457a";
    private String targetBucketName2 = "targetbucket4457b";
    private String sourceBucketName = "sourcebucket4457";
    private String targetKey = "/aa/bb/targetobj4457";
    private String sourceKey = "/aa/bb/sourceobj4457";
    ...
    private void setUp() throws Exception {
        ...
        S3Utils.clearBucket( s3Client, targetBucketName1 );
        S3Utils.clearBucket( s3Client, targetBucketName2 );
        S3Utils.clearBucket( s3Client, sourceBucketName );
        s3Client.createBucket( targetBucketName1 );
        s3Client.createBucket( targetBucketName2 );
    ...
    public void test() throws Exception {
        ...
        es.addWorker( new ThreadUploadPartCopy( sourceBucketName, sourceKey,
                targetBucketName1, targetKey ) );
        es.addWorker( new ThreadUploadPartCopy( sourceBucketName, sourceKey,
                targetBucketName2, targetKey ) );
        es.run();
