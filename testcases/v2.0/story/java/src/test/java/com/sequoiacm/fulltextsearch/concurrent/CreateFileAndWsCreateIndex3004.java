...
/**
 * @Description SCM-3004 :: 并发ws创建索引和更新文件，历史版本文件匹配file_matcher
 * @author wuyan
 * @Date 2020.11.07
 * @version 1.00
 */

public class CreateFileAndWsCreateIndex3004 extends TestScmBase {
    private boolean runSuccess = false;
    private static ScmSession session = null;
    private ScmWorkspace ws = null;
    private String filePath = null;
    private String fileName = "file3004";
    ...
    private void setUp() throws Exception {
        ...
        for ( int i = 0; i < fileNum; i++ ) {
            ...
            ScmId fileId = createFile( ws, subFileName, "matchtitle3004" );
    ...
    private void test() throws Exception {
        String mismatchTitle = "mismatchtitle3004";
        String matchTitle = "matchtitle3004";
        ...
        for ( int i = 0; i < fileNum; ++i ) {
            // 更新属性不匹配条件匹配条件file_matcher，不创建索引
            if ( i % 3 == 0 ) {
        ...
        // 防止变更文件属性导致文件索引状态不符合预期，需要做inspect
