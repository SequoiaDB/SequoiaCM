...
/**
 * @description SCM-6085:限额同步操作与上传对象并发
 * @author ZhangYanan
...
public class BucketQuota6085 extends TestScmBase {
    private boolean runSuccess = false;
    private String keyName = "object6085";
    private String bucketName = "bucket6085";
    ...
    public void test() throws Exception {
        ...
        t.addWorker( new SyncQuoteThread() );
        t.run();

        ScmBucketQuotaInfo quotaInfo = ScmFactory.Quota.getBucketQuota( session,
                bucketName );
        Assert.assertEquals( quotaInfo.getSyncStatus(),
                ScmQuotaSyncStatus.COMPLETED );
        checkObjectContent();
