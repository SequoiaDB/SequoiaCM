...
/**
 * @Descreption SCM-3304:指定ifMatch和ifUnModifiedSince条件获取对象，不匹配ifMatch（标准模式）
 * @Author YiPan
 * @Date 2020/3/11
 */
public class GetObject3304 extends TestScmBase {
    private boolean runSuccess = false;
    private String bucketName = "bucket3304";
    private String objectName = "object3304";
