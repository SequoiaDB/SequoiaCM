...
/**
 * @description SCM-4084:断点文件续传失败，查询统计信息
 * @author ZhangYanan
 ...
 * @version v1.0
 */
public class StatisticsFile4084 extends TestScmBase {
    private File localPath = null;
    private boolean runSuccess = false;
    private SiteWrapper site = null;
    private WsWrapper wsp = null;
    private String fileName = "file4084";
    ...
    public void test() throws Exception {
        try {
            ...
            ScmBreakpointFile breakpointFile = ScmFactory.BreakpointFile
                    .createInstance( siteWorkspace, fileName );
            FileInputStream fStream = new FileInputStream( filePath );
            breakpointFile.upload( fStream );
            Assert.fail( "uploadBreakPointFile should failed but success!" );
        ...
        ScmFileStatisticInfo expUploadInfo = new ScmFileStatisticInfo(
                ...
                TestScmBase.scmUserName, wsp.getName(), null, 0, 0, 0, 0, 0,
                0 );
