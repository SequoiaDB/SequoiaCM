...
/**
 * @Testcase: SCM-242:A中心写文件，B中心调用getContent文件方式分批读取文件 1、分中心A写文件，文件大小>1M
 *            2、分中心B读取文件，调用getContent，文件方式
...
public class AcrossCenterReadFileByGetContent276 extends TestScmBase {
	...
	private String fileName = "readCacheFile276";
