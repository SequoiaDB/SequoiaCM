...
/**
 * @Descreption SCM-6156:上传文件，修改工作区数据域，触发新建集合
 * @Author yangjianbo
 ...
 * @Version 1.0
 */
public class UpdateDomain6156 extends TestScmBase {
    private ScmSession session = null;
    private SiteWrapper rootSite = null;
    private String wsName = "ws6156";
    private String author = "Author6156";
    private String fileName = "file6156";
    ...
    public void test() throws Exception {
        ...
        ws.updateMetaDomain( doMainOld );
        upLoadFileNextCycle( fileName + 2, 2 );
        TestSdbTools.checkCsInDomain( sdb, wsName + csMeta, doMainOld );
        runSuccess = true;
    }
