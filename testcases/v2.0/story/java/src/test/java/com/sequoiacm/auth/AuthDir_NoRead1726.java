...
public class AuthDir_NoRead1726 extends TestScmBase {
    ...
    private void testGetDirByPath() {
        String dirpath = path;
        try {
            ScmFactory.Directory.getInstance( wsR, dirpath );
