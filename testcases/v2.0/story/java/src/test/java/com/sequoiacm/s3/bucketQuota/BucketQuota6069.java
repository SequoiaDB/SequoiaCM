...
/**
 * @description SCM-6069:暂停版本控制，上传对象（存在null版本）后统计桶流量信息
 * @author ZhangYanan
...
public class BucketQuota6069 extends TestScmBase {
    private boolean runSuccess = false;
    private String keyName = "object6069";
    private String bucketName = "bucket6069";
