...
/**
 * @Description: SCM-2349 :: 指定的userType与b指定的userMask不同，审计类型任意
 * @author fanyu
 * @Date:2018年12月25日
 * @version:1.0
 */
public class Audit2349 extends TestScmBase {
    private String fileName = "2349";
    private String dirName = "/2349A";
    private String username = "2349";
    ...
    private void setUp() throws Exception {
        ...
        ConfUtil.createUser(wsp, username, ScmUserPasswordType.TOKEN, new ScmPrivilegeType[]{ScmPrivilegeType.ALL});
    ...
    private void test() throws ScmException, InterruptedException {
        ...
        confMap.put(ConfigCommonDefind.scm_audit_userType + ScmUserPasswordType.TOKEN.name(), "FILE_DML");
        ...
        //check
        checkAudit(TestScmBase.scmUserName,TestScmBase.scmPassword,false, true);
    ...
    private void checkAudit(String username,String password,boolean isLogged1, boolean isLogged2) throws ScmException, InterruptedException {
        ...
        try {
            ...
            BSONObject bson2 = new BasicBSONObject().append(ScmAttributeName.Audit.TYPE, "CREATE_DIR")
                    .append(ScmAttributeName.Audit.USERNAME, username);
            ...
            Assert.assertEquals(ConfUtil.checkAudit(session, bson2, dirName), isLogged2, "Has the configuration been updated? dirPath = " + dirName);
        } finally {
            if (fileId != null) {
    ...
    private ScmId createFile(String username,String password) throws ScmException {
    ...
    private ScmDirectory createDir(String username,String password) throws ScmException {
        ScmSession session = null;
        ScmDirectory dir = null;
        try {
            session = TestScmTools.createSession(site,username,password);
