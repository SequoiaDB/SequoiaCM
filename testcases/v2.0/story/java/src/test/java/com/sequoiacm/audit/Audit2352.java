...
/**
 * @Description: SCM-2352 :: 指定username与指定的userMask用户类型相同，审计类型任意
 * @author fanyu
 * @Date:2018年12月25日
 * @version:1.0
 */
public class Audit2352 extends TestScmBase {
    private String fileName = "2352";
    private String dirName = "/2352A";
    private String username = "2352";
    ...
    private void setUp() throws Exception {
        ...
        ConfUtil.createUser(wsp, username, ScmUserPasswordType.LOCAL, new ScmPrivilegeType[]{ScmPrivilegeType.ALL});
