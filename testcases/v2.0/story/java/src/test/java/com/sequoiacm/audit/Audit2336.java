...
public class Audit2336 extends TestScmBase {
    ...
    private void test() throws ScmException {
        ...
        confMap.put(ConfigCommonDefind.scm_audit_userType+ScmUserPasswordType.LOCAL.name(),"FILE_DML|DIR_DML");
        ...
        checkAudit(TestScmBase.scmUserName,TestScmBase.scmPassword,true,true);
    ...
    private void checkAudit(String username, String password, boolean isLogged1, boolean isLogged2) throws ScmException {
        ...
        try {
            fileId = createFile(fileName + "_" + UUID.randomUUID(), username, password);
            ...
            Assert.assertEquals(ConfUtil.checkAudit(session,bson2,dirPath),isLogged2,"Has the configuration been updated? dirId = " + dir.getId());
        } finally {
            if (fileId != null) {
    ...
    private ScmId createFile(String fileName, String username, String password) throws ScmException {
