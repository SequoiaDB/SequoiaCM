...
/**
 * @description SCM-3707:创建调度任务，指定region中所有符合条件故障
 * @author YiPan
 ...
 * @version v1.0
 */
public class CreateSchedule3707 extends TestScmBase {
    private int fileSize = 1024 * 100;
    private File localPath = null;
    private String filePath = null;
    private String tmpPath = null;
    private String fileName = "file3707";
    private String region = TestScmBase.defaultRegion;
    private String zone = TestScmBase.zone2;
    ...
    public void test() throws Exception {
        ...
        System.err.println( cleanSchedule.getId().toString() );
        ...
        for ( int i = 300; i > 0; i-- ) {
            Thread.sleep( 1000 );
            System.out.println( "进程暂停时间剩余：" + i + "s" );
        }
        check( cleanSchedule );
        runSuccess = true;
    }
