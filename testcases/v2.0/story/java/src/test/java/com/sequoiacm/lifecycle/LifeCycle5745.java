...
/**
 * @descreption SCM-5745:更新全局Transition验证
 * @author YiPan
 * @date 2023/1/18
 * @updateUser
 * @updateDate
 ...
 * @version 1.0
 */
public class LifeCycle5745 extends TestScmBase {
    ...
    private String transitionName = "trans5745";
    ...
    public void test() throws ScmException {
        ...
        // 更新后的已存在
        ScmLifeCycleTransition updateTransition = ScmSystem.LifeCycleConfig
