...
/**
 * @descreption SCM-4650 :: 指定ifNoneMatch和ifModifiedSince条件获取对象
 * @author Zhaoyujing
 * @Date 2020/7/13
 * @updateUser
 * @updateDate
 ...
 * @version 1.0
 */
public class Object4650 extends TestScmBase {
    private boolean runSuccess = false;
    private String bucketName = "bucket4650";
    private String objectName = "object4650";
