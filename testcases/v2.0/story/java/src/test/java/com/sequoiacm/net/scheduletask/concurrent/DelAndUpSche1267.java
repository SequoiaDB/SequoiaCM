...
public class DelAndUpSche1267 extends TestScmBase {
	private static final Logger logger = Logger.getLogger(DelAndUpSche1267.class);
	...
	private void setUp() throws Exception {
		...
		ScmScheduleUtils.isRunningOfSche(ssA, scheduleId, CommonDefine.TaskType.SCM_TASK_TRANSFER_FILE);
