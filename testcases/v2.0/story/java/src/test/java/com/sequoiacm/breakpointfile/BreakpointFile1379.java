...
public class BreakpointFile1379 extends TestScmBase {
	...
	private void test() throws JSONException, ScmException, IOException {
		...
		BreakpointUtil.createBreakpointFile(ws, filePath, fileName, 1024*512, ScmChecksumType.CRC32);
	...
	private void breakpointFile2ScmFile(ScmBreakpointFile breakpointFile) throws ScmException {
		...
		try {
			...
			Assert.assertEquals(e.getErrorCode(), ScmError.OPERATION_UNSUPPORTED.getErrorCode(), "unCompleted breakpointFile can't be file");
		}
	}
	...
	private void checkFile() throws ScmException {
		...
		Assert.assertEquals(file.getSize(), 0, "check breakpointFile to file");
	}
}
