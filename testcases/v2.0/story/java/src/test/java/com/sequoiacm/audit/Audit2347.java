...
public class Audit2347 extends TestScmBase {
    ...
    private void checkAudit(boolean isLogged1, boolean isLogged2,boolean isLogged3) throws ScmException, InterruptedException {
        ScmId fileId = null;
        ...
        try {
            ...
            BSONObject bson2 = new BasicBSONObject().append(ScmAttributeName.Audit.TYPE, "FILE_DQL")
                    .append(ScmAttributeName.Audit.USERNAME, TestScmBase.scmUserName);
            BSONObject bson3 = new BasicBSONObject().append(ScmAttributeName.Audit.TYPE, "CREATE_DIR")
                    .append(ScmAttributeName.Audit.USERNAME, TestScmBase.scmUserName);
            ...
            Assert.assertEquals(ConfUtil.checkAudit(session, bson3, dirName), isLogged3, "Has the configuration been updated? dirPath = " + dirName);
        } finally {
            if (fileId != null) {
