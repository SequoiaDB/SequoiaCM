...
public class AuthWs_RootDirHasPriv1747 extends TestScmBase {
    ...
    private ScmPrivilegeType[] privileges = { ScmPrivilegeType.DELETE,
            ScmPrivilegeType.CREATE, ScmPrivilegeType.READ,
    ...
    private void test() {
        ...
        try {
            ...
            // get dir
            ScmDirectory actdir = ScmFactory.Directory.getInstance( ws,
                    dirpath );
            ...
            // check
            ScmDirectory actdir1 = ScmFactory.Directory.getInstance( ws,
                    newDirPath );
