...
public class AsyncTransferCurVersionFile1655 extends TestScmBase {	
	...
	private void test() throws Exception {			
		...
		Collection<ScmFileLocation> getSiteInfo1 = getSiteInfo(historyVersion);
		...
		Collection<ScmFileLocation> getSiteInfo2 = getSiteInfo(historyVersion);
		Assert.assertEquals(getSiteInfo1.toString(), getSiteInfo2.toString(), "fisrt get siteList:"
				+getSiteInfo1.toString()+" 2nd get siteList:"+getSiteInfo2.toString());			
	}
	...
	private void asyncTransferCurrentVersionFile(int majorVersion) throws Exception {	
		...
		//wait task finished
		int sitenums = 2;
		VersionUtils.waitAsyncTaskFinished(wsT, fileId, majorVersion, sitenums);			
	}
