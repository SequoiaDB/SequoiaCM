...
/**
 * @description SCM-4383:带Key-marker查询桶分段上传列表
 * @author ZhangYanan
...
public class MultipartUpload4383 extends TestScmBase {
    private int runSuccessNum = 0;
    private AmazonS3 s3Client;
    private final String bucketName = "bucket4383";
    private File localPath;
    private File file;
    private final long fileSize = 10 * 1024 * 1024;
    private final String[] keys = { "/aa/bb/test4383_1", "/aa/bb/test4383_2",
            "test4383_3", "test4383_4" };
    ...
    @Test(groups = { "oneSite", "twoSite", "fourSite" })
    public void test_ReturnLastRecs() {
        ListMultipartUploadsRequest request = new ListMultipartUploadsRequest(
