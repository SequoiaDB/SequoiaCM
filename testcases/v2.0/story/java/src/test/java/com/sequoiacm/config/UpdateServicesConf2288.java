...
public class UpdateServicesConf2288 extends TestScmBase {
    ...
    private void test() throws Exception {
        ...
        try {
            ...
            ConfUtil.checkResultSet(actResults, expOkNum, 0, expServiceNames, new ArrayList<String>());
        } finally {
            if (session != null) {
                session.close();
            }
        ...
        for (SiteWrapper updatedSite : updatedSites) {
            ...
            for (NodeWrapper node : updatedSite.getNodes(updatedSite.getNodeNum())) {
        ...
        for (SiteWrapper initSite : initdSites) {
            ...
            for (NodeWrapper node : initSite.getNodes(initSite.getNodeNum())) {
