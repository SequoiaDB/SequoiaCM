...
/**
 * @Description: SCM-1869 :: 模型重复关联属性
 * @author fanyu
 * @Date:2018年7月4日
 * @version:1.0
 */
public class DefineAttr_Class_ClassAttachAttr1869 extends TestScmBase {
    private boolean runSuccess = false;
    private String name = "ClassAttachAttr1869";
    private String desc = "ClassAttachAttr1869";
