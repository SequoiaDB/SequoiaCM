...
public class Transfer_readProgressAndStop442 extends TestScmBase {
	...
	private void test() {
		try {
			...
			StopTaskAndReadProgressThread TaskThreadA = new StopTaskAndReadProgressThread(siteList.get(0));
			StopTaskAndReadProgressThread TaskThreadB = new StopTaskAndReadProgressThread(siteList.get(1));
