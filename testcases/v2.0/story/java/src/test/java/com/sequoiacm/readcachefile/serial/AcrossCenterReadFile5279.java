...
/**
 * @Descreption SCM-5279:工作区配置不缓存策略，驱动配置不缓存策略跨站点读文件
 * @Author YiPan
 * @CreateDate
 * @UpdateUser
 ...
 * @Version
 */
public class AcrossCenterReadFile5279 extends TestScmBase {
    private final String fileNameBase = "file5279_";
    private final String fileAuthor = "author5279";
