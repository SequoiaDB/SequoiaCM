...
/**
 * @description SCM-6003:开启版本控制，上传对象后检查桶容量限额
 * @author ZhangYanan
...
public class BucketQuota6003 extends TestScmBase {
    private boolean runSuccess = false;
    private String keyName = "object6003";
    private String bucketName = "bucket6003";
