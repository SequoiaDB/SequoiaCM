...
public class Audit2335 extends TestScmBase {
    ...
    private void setUp() throws Exception {
        ...
        ConfUtil.createUser(wsp,name1, ScmUserPasswordType.LOCAL,new ScmPrivilegeType[]{ScmPrivilegeType.ALL});
        ConfUtil.createUser(wsp,name2, ScmUserPasswordType.TOKEN,new ScmPrivilegeType[]{ScmPrivilegeType.ALL});
        ConfUtil.createUser(wsp,name3, ScmUserPasswordType.LDAP,new ScmPrivilegeType[]{ScmPrivilegeType.ALL});
    }
    ...
    private void test() throws ScmException {
        ...
        confMap.put(ConfigCommonDefind.scm_audit_userType+ScmUserPasswordType.LOCAL.name(),"FILE_DML");
        ...
        confMap1.put(ConfigCommonDefind.scm_audit_userType+ScmUserPasswordType.TOKEN.name(),"FILE_DML");
        ...
        confMap2.put(ConfigCommonDefind.scm_audit_userType+ScmUserPasswordType.LDAP.name(),"FILE_DML");
        ...
        confMap3.put(ConfigCommonDefind.scm_audit_userType+"ALL","FILE_DML");
    ...
    private void checkAudit(String username,String password) throws ScmException {
        ScmId fileId = null;
        try{
            fileId = createFile(username,password,fileName+"_"+UUID.randomUUID());
            Assert.assertEquals(ConfUtil.checkAudit(session,new BasicBSONObject().append(ScmAttributeName.Audit.TYPE, "CREATE_FILE")
                    ,fileId.get()),true,"Has the configuration been updated? fileId = " + fileId.get());
        }finally{
            if(fileId != null){
    ...
    private ScmId createFile(String username,String password,String fileName) throws ScmException {
