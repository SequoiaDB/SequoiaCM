...
/**
 * @description SCM-6092:限额同步操作与删除对象并发
 * @author ZhangYanan
...
public class BucketQuota6092 extends TestScmBase {
    private boolean runSuccess = false;
    private String keyName = "object6092";
    private String bucketName = "bucket6092";
    ...
    public void test() throws Exception {
        ...
        t.addWorker( new SyncBucketQuotaThread() );
    ...
    private class SyncBucketQuotaThread {
        @ExecuteOrder(step = 1)
        private void run() throws Exception {
            try ( ScmSession session = ScmSessionUtils
                    .createSession( rootSite )) {
