...
/**
 * @descreption SCM-5670:并发修改相同节点不同配置项
 * @author YiPan
 * @date 2022/12/28
 * @updateUser
 * @updateDate
 ...
 * @version 1.0
 */
public class Audit5670 extends TestScmBase {
    private final String newUserName = "user5670";
    ...
    public void test() throws Exception {
        ...
        t.addWorker( new UpdateConfig( UserMap ) );
        t.run();
    ...
    private void init() {
        UserMap.put( com.sequoiacm.audit.ConfigCommonDefind.scm_audit_userMask,
                "LOCAL" );
