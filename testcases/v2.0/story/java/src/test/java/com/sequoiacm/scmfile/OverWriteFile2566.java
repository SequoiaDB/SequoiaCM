...
/**
 * @Description: SCM-2566:指定isOverwrite参数，断点文件转换/更新不带有批次的同名scm文件（被覆盖的文件大小为0）
 * @author fanyu
 * @Date:2019年8月21日
 * @version:1.0
 */
public class OverWriteFile2566 extends TestScmBase {
    private boolean runSuccess = false;
    private SiteWrapper site;
    private WsWrapper wsp;
    private ScmSession session;
    private ScmWorkspace ws;
    private String fileName = "file2566";
    private ScmId fileId;
    private File localPath;
    private int fileSize = 0;
    private int updateFileSize = new Random().nextInt(1024)*1024;
    ...
    private void setUp() throws IOException, ScmException {
        ...
        filePath = localPath + File.separator + "localFile_C" + fileSize + ".txt";
        updateFilePath = localPath + File.separator + "localFile_U" + updateFileSize + ".txt";
