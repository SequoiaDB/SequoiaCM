...
/**
 * @descreption SCM-4690 :: 开启版本控制存在删除标记的对象，查询对象版本列表
 * @author Zhaoyujing
 * @Date 2020/7/13
 * @updateUser
 * @updateDate
 ...
 * @version 1.0
 */
public class Object4690 extends TestScmBase {
    private String bucketName = "bucket4690";
    private String keyName = "object4690";
    private String fileContent = "content4690";
    ...
    private void setUp() throws Exception {
        ...
        // put object key = "object4690_1" again
        s3Client.putObject( bucketName, keyNameList.get( 1 ), fileContent );
        expVersionsKeyNameList.add( keyNameList.get( 1 ) );

        // delete object key = "object4690_1" and "object4690_4"
    ...
    private void checklistVersionsResult( List< S3VersionSummary > versions ) {
        ...
        for ( int i = 0; i < expVersionsKeyNameList.size(); i++ ) {
            Assert.assertEquals( versions.get( i ).getKey(),
                    expVersionsKeyNameList.get( i ), "key name is wrong" );
