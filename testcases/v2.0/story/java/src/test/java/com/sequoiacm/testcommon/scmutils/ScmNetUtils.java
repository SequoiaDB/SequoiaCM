...
public class ScmNetUtils extends TestScmBase {
	...
	private List<SiteWrapper> init(WsWrapper wsWrapper) throws ScmException{
		...
		for (BSONObject dataLocation : dataLocationList) {
			for (SiteWrapper siteWrapper : allSiteList) {
				if((int)dataLocation.get(SITE_ID) == siteWrapper.getSiteId()){
	 ...
	 * @throws ScmException 
	 */
	public static SiteWrapper getRootSite(WsWrapper wsWrapper) throws ScmException{
	 ...
	 * @throws ScmException 
	 */
	public static SiteWrapper getLastSite(WsWrapper wsWrapper) throws ScmException{
	 ...
	 * @throws ScmException 
	 */
	public static SiteWrapper getNonLastSite(WsWrapper wsWrapper) throws ScmException{
		ScmNetUtils net = new ScmNetUtils();
		List<SiteWrapper> siteList = net.init(wsWrapper);
	 ...
	 * @throws ScmException 
	 */
	public static List<SiteWrapper> getCleanSites(WsWrapper wsWrapper) throws ScmException{
		ScmNetUtils net = new ScmNetUtils();
		List<SiteWrapper> siteList = net.init(wsWrapper);
	 ...
	 * @throws ScmException 
	 */
	public static List<SiteWrapper> getAllSite(WsWrapper wsWrapper) throws ScmException{
		ScmNetUtils net = new ScmNetUtils();
		List<SiteWrapper> siteList = net.init(wsWrapper);
		return siteList;
	}
	...
	/**
	 * return a list of two site,the level is random, list.get(0) sourceSite, list.get(1) targetSite
	 * use: transfer or asyncCache
	 * @return
	 * @throws ScmException 
	 */
	public static List<SiteWrapper> getRandomSites(WsWrapper wsWrapper) throws ScmException{
		ScmNetUtils net = new ScmNetUtils();
		List<SiteWrapper> siteList = net.init(wsWrapper);
	 ...
	 * @throws ScmException 
	 */
	public static List<SiteWrapper> getSortSites(WsWrapper wsWrapper) throws ScmException{
		ScmNetUtils net = new ScmNetUtils();
		List<SiteWrapper> siteList = net.init(wsWrapper);
