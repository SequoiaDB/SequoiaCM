...
/**
 * @Descreption SCM-6131:创建调度任务(基础场景、删除用户角色、删除用户、删除资源 4 中场景)
 * @Author yangjianbo
 ...
 * @Version 1.0
 */
public class AuthSchedule_AuthNormal6131 extends TestScmBase {
    ...
    private String userName = "AuthSchedule6131UserName";
    private String passwd = "AuthSchedule6131Pwd";
    private String roleName = "AuthSchedule6131RoleName";
    private String wsName = "AuthSchedule6131WsName";
    ...
    private void testDeleteResource() throws Exception {
        ...
        ScmWorkspaceUtil.deleteWs( wsName, session );
        try {
            createSchedule( "testDeleteResource" );
    ...
    private void testDeleteUserRole() throws Exception {
        ...
        try {
            createSchedule( "testDeleteUserRole" );
            Assert.fail( "except fail but success" );
        } catch ( ScmException exception ) {
            if ( exception.getErrorCode() != ScmError.HTTP_UNAUTHORIZED
                    .getErrorCode() ) {
    ...
    private void prepare() throws Exception {
        fileNameList.add( "testNormal" );
        fileNameList.add( "testDeleteUserRole" );
        fileNameList.add( "testDeleteRole" );
        fileNameList.add( "testDeleteResource" );
