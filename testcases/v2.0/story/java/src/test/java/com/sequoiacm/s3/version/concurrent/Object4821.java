...
/**
 * @Description: SCM-4821 :: 开启版本控制，并发删除和获取同一对象的不同版本
 * @author wuyan
 * @Date 2022.07.20
 * @version 1.00
 */
public class Object4821 extends TestScmBase {
    private boolean runSuccess = false;
    private String bucketName = "bucket4821";
    private String keyName = "对象%key4821";
    ...
    public void testCreateObject() throws Exception {
        ...
        String getVersion = "3.0";
        ThreadExecutor es = new ThreadExecutor();
        DeleteObject deleteObject = new DeleteObject( keyName, deleteVersion );
        GetObject getObject = new GetObject( keyName, getVersion );
