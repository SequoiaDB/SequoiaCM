...
/**
 * @Description SCM-5229:并发执行多个迁移并清理任务，源站点不同，目标站点相同
 * @Author zhangyanan
 * @Date 2022.09.21
 ...
 * @version 1.00
 */
public class ScheduleTask5229 extends TestScmBase {
    private final static int fileSize = 1024;
    private final static String filename = "file5229";
    private ScmSession rootSiteSession = null;
    private ScmSession branSession1 = null;
    private ScmSession branSession2 = null;
    private ScmWorkspace rootSiteWs = null;
    private ScmWorkspace branSiteWs1 = null;
    private ScmWorkspace branSiteWs2 = null;
    ...
    public void test() throws Exception {
        ...
        if ( moveTask1.getSuccessCount() == 1
            ...
            expSite = new SiteWrapper[] { rootSite, branchSite1 };
        } else if ( moveTask1.getSuccessCount() == 1
                && moveTask2.getSuccessCount() == 1 ) {
    ...
    public void tearDown() throws Exception {
        try {
            ...
            if ( branSession1 != null ) {
                branSession1.close();
            }
            if ( branSession2 != null ) {
                branSession2.close();
            }
        }
    }
    ...
    public void prepareDate() throws Exception {
        ...
        ScmFactory.File.asyncCache( branSiteWs1, fileId );
        ScmTaskUtils.waitAsyncTaskFinished( branSiteWs1, fileId, 2 );

        ScmFactory.File.asyncCache( branSiteWs2, fileId );
        ScmTaskUtils.waitAsyncTaskFinished( branSiteWs2, fileId, 3 );

        ScmId taskId = ScmSystem.Task.startCleanTask( rootSiteWs, queryCond );
