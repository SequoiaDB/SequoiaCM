...
public class AuthWs_RevokeRs1779 extends TestScmBase {
    ...
    private class RevokeRs extends TestThreadBase {
        ...
        public void exec() throws InterruptedException {
            try {
                ScmFactory.Role.revokePrivilege(sessionA, this.role, rs, ScmPrivilegeType.READ);
                Thread.sleep(20000);
            } catch (ScmException e) {
                e.printStackTrace();
                Assert.fail(e.getMessage());
    ...
    private void prepare() throws Exception {
        ...
        ScmAuthUtils.checkPriority(site, username, passwd, roleList.get(roleList.size() - 1), wsp);
    }
}
