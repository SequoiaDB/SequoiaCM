...
public class Object4255_4256 extends TestScmBase {
    ...
    public void test() throws Exception {
        ...
        checkResult( scmFileBasicInfoScmCursor, objectKeys, false );
        ...
        List< String > actObjectKeys = new ArrayList<>();
        actObjectKeys.add( objectKey + 27 );
        actObjectKeys.add( objectKey + 25 );
        actObjectKeys.add( objectKey + 23 );
        checkResult( scmFileBasicInfoScmCursor, actObjectKeys, true );
        runSuccess = true;
    }
