...
public class AuthWsDir_CreateDelete1730 extends TestScmBase {
    ...
    private void testMoveDir() throws ScmException {
        ...
        ScmId fileId = null;
        try {
            ScmDirectory srcDir = ScmFactory.Directory.getInstance(wsCRUD, srcpath);
            ScmDirectory dstDir = ScmFactory.Directory.getInstance(wsCRUD, dstpath);
            srcDir.move(dstDir);
            ScmDirectory actdir = ScmFactory.Directory.getInstance(wsCRUD, newpath);
    ...
    private void tearDown() {
        try {
            ...
            ScmFactory.Role.revokePrivilege(sessionA, role, wsrs, ScmPrivilegeType.DELETE);
    ...
    private void prepare() throws Exception {
        try {
            ...
            dirrs = ScmResourceFactory.createDirectoryResource(wsp.getName(), basepath + "/1730_A/1730_B/1730_C/");

            grantPriAndAttachRole(sessionA, wsrs, user, role, ScmPrivilegeType.DELETE);
