...
public class OverWriteFile2676 extends TestScmBase {
    ...
    private String fileName = "file2576";
    ...
    private String username = "user2576";
    private String rolename = "role2576";
    private ScmUser scmUser;
    private ScmRole scmRole;
    private String passwd = "2576";
    ...
    private void test() throws Exception {
        ...
        ScmResource dirResource = ScmResourceFactory.createDirectoryResource(wsp.getName(), scmDir);
        ScmResource wsResource = ScmResourceFactory.createWorkspaceResource(wsp.getName());
    ...
    private void overwriteFile() throws ScmException, FileNotFoundException {
        ...
        try {
            ...
            ScmWorkspace ws1 = ScmFactory.Workspace.getWorkspace(wsp.getName(), session1);
    ...
    private void prepareScmFile() throws ScmException {
        ...
        ScmDirectory scmDirectory = ScmFactory.Directory.createInstance(ws, scmDir);
    ...
    private void prepareUser() throws Exception {
        ...
        scmUser = ScmFactory.User.createUser(session, username, ScmUserPasswordType.LOCAL, passwd);
    ...
    private void grantPrivilege(ScmResource rs, ScmPrivilegeType privileges) throws Exception {
        ScmFactory.Role.grantPrivilege(session, scmRole, rs, privileges);
        ScmAuthUtils.checkPriority(site, username, passwd, scmRole, wsp.getName());
    }

    private void revokePrivilege(ScmResource rs, ScmPrivilegeType privileges) throws Exception {
