 ...
 * @version 1.0
 */
public class Bucket4618 extends TestScmBase {
    private AmazonS3 s3Client = null;
    private boolean runSuccess = false;
    private final String bucketNameA = "bucket4618a";
    private final String bucketNameB = "bucket4618b";
    ...
    public void test() throws Exception {
        ...
        S3Utils.setBucketVersioning( s3Client, bucketNameA, "Enabled" );
