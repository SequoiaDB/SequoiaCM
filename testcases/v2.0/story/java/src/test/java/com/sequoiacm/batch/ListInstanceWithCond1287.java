...
public class ListInstanceWithCond1287 extends TestScmBase {
	...
	private void test() throws Exception {
        ...
        int total = 0;
		ScmCursor<ScmBatchInfo> cursor = ScmFactory.Batch.listInstance(ws, new BasicBSONObject("name", batchName));
        ...
        total = 0;
        BSONObject tagBson =ScmQueryBuilder.start("tags").in("tag1287我是标签_0").get();
        ...
        while (cursor.hasNext()) {
            ...
            Assert.assertEquals(batch.getTags().toSet().contains("tag1287我是标签_0"), true,
