...
/**
 * @descreption SCM-4807 :: 并发创建相同桶，设置不同版本控制状态
 * @author Zhaoyujing
 * @Date 2020/7/13
 * @updateUser
 * @updateDate
 ...
 * @version 1.0
 */
public class Bucket4807 extends TestScmBase {
    private boolean runSuccess = false;
    private String bucketName = "bucket4807";
    ...
    public void test() throws Exception {
        ...
        if ( 0 == t2.getRetCode() ) {
            BucketVersioningConfiguration configuration = s3Client
                    .getBucketVersioningConfiguration( bucketName );
            Assert.assertEquals( configuration.getStatus(), "Suspended" );
        }
    ...
    private class CreateBucket extends ResultStore {
        ...
        CreateBucket( String versioningStatus ) {
