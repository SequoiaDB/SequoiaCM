...
/**
 * @description SCM-6011:禁用版本控制后删除对象，检查桶容量限额
 * @author ZhangYanan
...
public class BucketQuota6011 extends TestScmBase {
    private boolean runSuccess = false;
    private String keyName = "object6011";
    private String bucketName = "bucket6011";
