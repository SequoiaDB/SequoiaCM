...
/**
 * @descreption SCM-4883 :: 禁用版本控制，并发更新和删除相同文件
 * @author Zhaoyujing
 * @Date 2020/7/23
 * @updateUser
 * @updateDate
 ...
 * @version 1.0
 */
public class Object4883 extends TestScmBase {
    private AmazonS3 s3Client = null;
    private ScmSession session = null;
    private ScmWorkspace ws = null;
    private boolean runSuccess = false;
    private String bucketName = "bucket4883";
    private String keyName = "aa/bb/object4883";
