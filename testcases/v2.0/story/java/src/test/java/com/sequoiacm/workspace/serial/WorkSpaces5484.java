...
/**
 * @descreption SCM-5484:修改数据源分区规则与文件修改验证
 * @author ZhangYanan
 * @date 2022/11/29
 * @updateUser
 * @updateDate
 ...
 * @version 1.0
 */
public class WorkSpaces5484 extends TestScmBase {
    private ScmSession session = null;
    private SiteWrapper site = null;
    private String wsName = "ws5484";
    private String fileName1 = "file5484_1";
    private String fileName2 = "file5484_2";
