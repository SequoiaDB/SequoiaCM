...
/**
 * @Testcase: SCM-237:A中心写文件，B中心调用read输出流方式一次性读取文件 1、分中心A写文件，文件大小<=1M 2、分中心B读取文件
 * @author huangxiaoni init
 * @date 2017.5.4
 */

public class AcrossCenterReadFileByStream237 extends TestScmBase {
    ...
    private String fileName = "readCacheFile237";
