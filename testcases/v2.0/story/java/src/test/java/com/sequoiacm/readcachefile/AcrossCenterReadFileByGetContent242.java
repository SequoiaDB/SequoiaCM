...
/**
 * @Testcase: SCM-242:A中心写文件，B中心调用getContent输出流方式分批读取文件 1、分中心A写文件，文件大小>1M
 *            2、分中心B读取文件，调用getContent，输出流方式
 * @author huangxiaoni init
 * @date 2017.5.5
 */

public class AcrossCenterReadFileByGetContent242 extends TestScmBase {
	...
	private String fileName = "readCacheFile242";
