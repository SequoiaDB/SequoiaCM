...
public class ListInstanceByScope1680_1681_1682 extends TestScmBase {
	...
	private void setUp() throws IOException, ScmException {		
		...
		fileId1 = VersionUtils.createFileByStream( ws, fileName1, writedata, authorName );
		fileId2 = VersionUtils.createFileByStream( ws, fileName2, writedata, authorName );
	}
	...
	private void listInstanceByNoHistoryVersion(ScmId fileId) throws ScmException{
		BSONObject condition = ScmQueryBuilder.start(ScmAttributeName.File.FILE_ID)
									.is(fileId.get()).get();		
	...
	private void listInstanceByHistoryVersion(ScmId fileId, String fileName) throws ScmException{
		BSONObject condition = ScmQueryBuilder.start(ScmAttributeName.File.FILE_ID)
									.is(fileId.get()).get();		
		ScmCursor<ScmFileBasicInfo> cursor = ScmFactory.File
								.listInstance(ws, ScopeType.SCOPE_HISTORY, condition);
	...
	private void listInstanceByCurrentVersion(List<String> expectFileNames) throws ScmException{
