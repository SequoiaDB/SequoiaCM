...
//
///**
// * @Descreption SCM-6227:使用and组合多个contains检索文件
// * @Author YiPan
...
// * @Version
// */
//public class TagRetrieval6227 extends TestScmBase {
//    private String fileNameBase = "file6227_";
//    private String fileAuthor = "author6227";
//    private String wsName = "ws6227";
...
//        // 1. 字符串标签包含tag1 and 自由标签包含tag2=vtag2的文件
...
//
//        // 2. 字符串标签包含tag1 and 自由标签包含test=test的文件
...
//        TagRetrievalUtils.checkSearchFileList( scmCursor, expFileList );
//
//        // 3. 字符串标签包含test and 自由标签包含test=test的文件
//        tagCondition = ScmTagConditionBuilder.builder().tags()
//                .contains( "test" ).build();
//        customTagCondition = ScmTagConditionBuilder.builder().customTag()
//                .contains( "test", "test" ).build();
