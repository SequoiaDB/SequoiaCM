...
//
///**
// * @Descreption SCM-6208:文件并发添加单个相同自由标签
// * @Author yangjianbo
...
// * @Version 1.0
// */
//public class TagRetrieval6208 extends TestScmBase {
//    private ScmSession session = null;
//    private SiteWrapper rootSite = null;
//    private WsWrapper wsp = null;
//    private BSONObject queryCond = null;
//    private String fileAuthor = "auth6208";
//    private int fileSize = 1024 * 1024;
//    private String filePath = null;
//    private File localPath = null;
//    private ScmWorkspace ws = null;
//    private String fileName = "file6208_";
...
//        
//
//        // 启动两个并发线程，并发添加单个自由标签，标签键值相同
//        ThreadExecutor threadExec = new ThreadExecutor();
//        int threadNum = 5;
//        for ( int i = 0; i < threadNum; i++ ) {
//            threadExec.addWorker( new AddTag( scmId, "key", "value" + i ) );
//        }
//        threadExec.run();
//
//        // 查看添加结果
//        ScmFile instance = ScmFactory.File.getInstance( ws, scmId );
//        Assert.assertEquals( instance.getCustomTag().size(), 1 );
//        runSuccess = true;
//    }
//
//    @AfterClass
