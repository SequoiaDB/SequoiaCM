...
/**
 * @descreption SCM-4863 :: 禁用版本控制，并发更新和删除相同文件
 * @author Zhaoyujing
 * @Date 2020/7/21
 * @updateUser
 * @updateDate
 ...
 * @version 1.0
 */
public class ScmFile4863 extends TestScmBase {
    private ScmSession session = null;
    private ScmWorkspace ws = null;
    private boolean runSuccess = false;
    private String bucketName = "bucket4863";
    private String keyName = "aa/bb/object4863";
