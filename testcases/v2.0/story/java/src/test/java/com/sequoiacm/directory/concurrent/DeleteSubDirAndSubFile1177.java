...
/**
 * @Description: SCM-1177 :: 并发删除同父文件夹下的子文件夹，子文件
 * @author fanyu
 * @Date:2018年5月2日
 * @version:1.0
 */
public class DeleteSubDirAndSubFile1177 extends TestScmBase {
    private boolean runSuccess;
    private ScmSession session;
    private ScmWorkspace ws;
    private SiteWrapper site;
    private WsWrapper wsp;
    private String dirBasePath = "/DeleteSubDirAndSubFile1177";
    private String fullPath1 = dirBasePath;
    private List< String > subPathList = new ArrayList< String >();
    private List< ScmId > fileIdList = new ArrayList< ScmId >();
    private String author = "DeleteSubDirAndSubFile1177";
    ...
    private void setUp() {
        try {
            ...
            for ( int i = 'a'; i < 'f'; i++ ) {
                String path = dirBasePath + "/1177_" + ( char ) i;
