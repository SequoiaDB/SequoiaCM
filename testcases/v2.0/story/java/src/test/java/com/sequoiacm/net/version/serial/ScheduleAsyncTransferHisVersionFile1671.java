...
public class ScheduleAsyncTransferHisVersionFile1671 extends TestScmBase {
    ...
    private String authorName = "fileVersion1671";
    ...
    private void test() throws Exception {
        ...
        SiteWrapper[] expSites1 = { sourceSite };
        VersionUtils.checkSite( wsS, fileId1, 2, expSites1 );

        SiteWrapper[] expSites2 = { targetSite, sourceSite };
        VersionUtils.checkSite( wsT, fileId2, 2, expSites2 );
