...
/**
 * @Descreption SCM-5247:修改空间回收任务为清理任务
 * @Author YiPan
 ...
 * @Version
 */
public class SpaceRecycle5247 extends TestScmBase {
    private String fileName = "file5247_";
    private String taskName = "task5247";
    private String fileAuthor = "author5247";
    ...
    public void test() throws Exception {
        ...
        sche.updateSchedule( ScheduleType.CLEAN_FILE, cleanFileContent );
        sche.enable();
        ScmScheduleUtils.waitForTask( sche, 2 );
