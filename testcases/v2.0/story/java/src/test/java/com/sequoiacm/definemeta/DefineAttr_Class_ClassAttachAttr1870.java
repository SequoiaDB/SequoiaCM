...
/**
 * @Description: SCM-1870 :: 模型关联不存在的属性
 * @author fanyu
 * @Date:2018年7月4日
 * @version:1.0
 */
public class DefineAttr_Class_ClassAttachAttr1870 extends TestScmBase {
	private boolean runSuccess = false;
	private String name = "ClassAttachAttr1870";
	private String desc = "ClassAttachAttr1870";
