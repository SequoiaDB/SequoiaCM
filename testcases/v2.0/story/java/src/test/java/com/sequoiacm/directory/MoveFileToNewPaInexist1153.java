...
public class MoveFileToNewPaInexist1153 extends TestScmBase {
	...
	private String fullPath1 = dirBasePath + "/1153_b/MoveFileToNewPaInexist1153/1153_d/1153_e";
	...
	private void test() throws ScmException {
		...
		try {
			...
			ScmDirectory dir = ScmFactory.Directory.createInstance(ws, "/1153_a");
			ScmFactory.Directory.deleteInstance(ws, "/1153_a");
			file = ScmFactory.File.getInstance(ws, fileId);
			file.setDirectory(dir);
			Assert.fail("it is not successful when new directory does not exist");
