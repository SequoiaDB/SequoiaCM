...
/**
 * @Descreption SCM-5281:工作区配置尽可能缓存策略，驱动配置不缓存策略跨站点读文件
 * @Author YiPan
 * @CreateDate
 * @UpdateUser
 ...
 * @Version
 */
public class AcrossCenterReadFile5281 extends TestScmBase {
    private final String fileNameBase = "file5281_";
    private final String fileAuthor = "author5281";
    ...
    public void test() throws Exception {
        // 从分站点读主站点单版本文件,指定readFlag=SCM_READ_FILE_FORCE_NO_CACHE
        readCurrentFile();

        // 从分站点读主站点多版本文件,指定readFlag=SCM_READ_FILE_FORCE_NO_CACHE
        readHistoryFile();
