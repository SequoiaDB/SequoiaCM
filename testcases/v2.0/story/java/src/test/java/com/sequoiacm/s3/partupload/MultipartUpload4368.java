...
/**
 * @description SCM-4368:终止分段上传后查询分段列表
 * @author ZhangYanan
...
public class MultipartUpload4368 extends TestScmBase {
    private boolean runSuccess = false;
    private String keyName = "/aa/object4368";
    private String bucketName = "bucket4368";
