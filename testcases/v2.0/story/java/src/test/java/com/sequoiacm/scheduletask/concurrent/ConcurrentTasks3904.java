...
/**
 * @description SCM-3904:并发执行迁移任务，不同源站点，不同目标站点，迁移相同文件
 * @author ZhangYanan
 ...
 * @version v1.0
 */
public class ConcurrentTasks3904 extends TestScmBase {
    private String fileName = "file3904";
    ...
    public void setUp() throws Exception {
        ...
        asyncCaheFile( branchSite1 );
    }

    @Test(groups = { "fourSite", "net" })
    public void test() throws Exception {
        ThreadExecutor es = new ThreadExecutor();
        es.addWorker( new ThreadFileMigration( branchSite2, rootSite ) );
        es.addWorker( new ThreadFileMigration( branchSite3, branchSite1 ) );
        es.run();
    ...
    public void asyncCaheFile( SiteWrapper branchSite ) throws Exception {
