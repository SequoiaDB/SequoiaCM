...
public class BreakpointFile1376 extends TestScmBase {
	...
	private void test() throws JSONException, ScmException, IOException, InterruptedException {
		
		//创建断点文件,大小为1024*512
		BreakpointUtil.createBreakpointFile(ws1, filePath,fileName,1024*512, ScmChecksumType.NONE);
		//创建新用户密码
		this.createScmUser();
		//使用新用户上传文件
	...
	private void uploadBreakpointFile() throws ScmException, IOException, InterruptedException {
