 ...
 * @Version
 */
public class Bucket4278 extends TestScmBase {
    private final String bucketName = "bucket4278";
    private final String objectName = "object4278";
    private final String content = "content4278";
    private ScmSession adminSession;
    private ScmSession newUserSession;
    private final String username = "user4278";
    private final String password = "passwd4278";
    private final String roleName = "ROLE_WS4278";
    ...
    public void test() throws Exception {
        ...
        // 仅赋予桶权限删除、创建、查询、更新
        alterUser( adminSession, ScmPrivilegeType.ALL );
        ScmAuthUtils.checkBucketPriorityByS3( accessKeys, bucketName );
