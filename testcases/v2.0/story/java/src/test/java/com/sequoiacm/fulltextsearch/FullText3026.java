...
/**
 * @Description: SCM-3026 :: 非空工作区且工作区索引状态为creating，有消息等待被消费，工作区删除索引
 * @author fanyu
 * @Date:2020/11/12
 * @version:1.0
 */
public class FullText3026 extends TestScmBase {
    ...
    private String fileNameBase = "file3026_";
