...
/**
 * @description SCM-6005:暂停版本控制，上传对象（存在null版本）后检查桶容量限额
 * @author ZhangYanan
...
public class BucketQuota6005 extends TestScmBase {
    private boolean runSuccess = false;
    private String keyName = "object6005";
    private String bucketName = "bucket6005";
