...
/**
 * @Testcase: SCM-413:迁移在主中心被残留的文件（大小/内容均一致）
...
public class Transfer_rootSiteRemainLob413 extends TestScmBase {
	...
	private void testTransfer() throws Exception {
		...
		TestSdbTools.Lob.putLob(targetSite, ws_T, fileId, filePathList.get(startNum));
		startTaskFromSubCenterA(sessionA); // contain remaining lob
