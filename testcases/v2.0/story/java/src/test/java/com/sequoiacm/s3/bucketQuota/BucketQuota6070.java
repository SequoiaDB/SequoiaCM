...
/**
 * @description SCM-6070:复制对象上传后统计桶流量信息
 * @author ZhangYanan
...
public class BucketQuota6070 extends TestScmBase {
    private boolean runSuccess = false;
    private String keyName = "object6070";
    private String bucketName1 = "bucket6070a";
    private String bucketName2 = "bucket6070b";
    ...
    private void setUp() throws Exception {
        ...
        s3Client.putObject( bucketName1, keyName, new File( filePath ) );
    }

    @Test
    public void test() throws Exception {
        s3Client.copyObject( bucketName1, keyName, bucketName2, keyName );
    ...
    public void checkObjectDelta() throws ScmException {
        ...
        Assert.assertEquals( objectDelta.getSizeDelta(), fileSize );
        Assert.assertTrue(
