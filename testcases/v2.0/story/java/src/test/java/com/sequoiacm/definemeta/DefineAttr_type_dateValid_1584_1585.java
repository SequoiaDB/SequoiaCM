...
//	private static final Logger logger = Logger.getLogger(DefineAttr_dateValid_1584_1585.class);
	...
	private void test_setPropValidLeftBound() throws Exception {
		...
		Assert.assertEquals(properties.getProperty("test_attr_name_date_1585_1"), date);
		Assert.assertEquals(properties.getProperty("test_attr_name_date_1585_3"), date);
	...
	private void test_setPropValidFormat() throws Exception {	
		...
		ScmFile file = ScmFactory.File.getInstance(ws, fileId);
		ScmClassProperties properties = new ScmClassProperties(CLASS_ID);
		properties.addProperty("test_attr_name_date_1585_1", "0001-01-01-00:00:00.000");
		properties.addProperty("test_attr_name_date_1585_2", "1000-12-31-23:59:59.999");
		properties.addProperty("test_attr_name_date_1585_3", "0001-01-01-00:00:00.000");
		file.setClassProperties(properties);
		
		// check results
		file = ScmFactory.File.getInstance(ws, fileId);
		properties = file.getClassProperties();
		Assert.assertEquals(properties.getProperty("test_attr_name_date_1585_1"), "0001-01-01-00:00:00.000");
		Assert.assertEquals(properties.getProperty("test_attr_name_date_1585_2"), "1000-12-31-23:59:59.999");
		Assert.assertEquals(properties.getProperty("test_attr_name_date_1585_3"), "0001-01-01-00:00:00.000");
