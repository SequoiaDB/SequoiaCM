...
/**
 * @Description: SCM-1852 :: 普通用户列取模型
 * @author fanyu
 * @Date:2018年7月4日
 * @version:1.0
 */
public class DefineAttr_Class_List1852 extends TestScmBase {
    private boolean runSuccess = false;
    private String classname = "List1852";
    private String desc = "List1852";
    ...
    private String username = "List1852";
    private String rolename = "List1852";
    ...
    private void test() throws Exception {
        try {
            ...
            ScmFactory.Class.listInstance( ws, new BasicBSONObject() );
