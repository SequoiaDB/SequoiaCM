...
/**
 * @descreption SCM-5347:按文件路径删除多版本文件
 * @author ZhangYanan
 * @date 2022/10/12
 * @updateUser
 * @updateDate
 ...
 * @version 1.0
 */
public class ScmFile5347 extends TestScmBase {
    ...
    private String fileName = "file5347";
    ...
    public void test() throws Exception {
        ...
        ScmId fileId = file2.save();
        file2.updateContent( filePath1 );
