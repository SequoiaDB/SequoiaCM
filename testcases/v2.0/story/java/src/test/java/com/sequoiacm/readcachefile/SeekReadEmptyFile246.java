...
/**
 * @Testcase: SCM-246:seek空文件，偏移=文件长度 1、分中心A写文件，文件为空；
 *            2、分中心B调用seek偏移读取文件，size=文件长度； 3、调用read(OutPutStream out)读取文件；
...
public class SeekReadEmptyFile246 extends TestScmBase {
    ...
    private String fileName = "readCacheFile246";
