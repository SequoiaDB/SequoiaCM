...
public class DeleteSche_taskRunning1261 extends TestScmBase {
	private static final Logger logger = Logger.getLogger(DeleteSche_taskRunning1261.class);
	...
	private void test() throws Exception {
		...
		ScmScheduleUtils.checkScmFile(wsA, fileIds, fileNum, fileNum + 10, expSites2); 
