...
/**
 * @Description: SCM-3051 :: 并发工作区创建索引和删除工作区
 * @author fanyu
 * @Date:2020/11/17
 * @version:1.0
 */
public class FullText3051 extends TestScmBase {
    private SiteWrapper site = null;
    private ScmSession session = null;
    private String wsName = "ws3051";
    private ScmWorkspace ws = null;
    private List< ScmId > fileIdList = new ArrayList<>();
    private String fileNameBase = "file3051-";
    ...
    private void test() throws Throwable {
        ...
        threadExec.addWorker( new CreateIndex() );
