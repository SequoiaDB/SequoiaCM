...
/**
 * @description SCM-4384:带uploadIdMarker查询桶分段上传列表
 * @author ZhangYanan
...
public class MultipartUpload4384 extends TestScmBase {
    private boolean runSuccess = false;
    private AmazonS3 s3Client;
    private final String bucketName = "bucket4384";
    private File localPath;
    private File file;
    private final long fileSize = 11 * 1024 * 1024;
    private final String[] keys = { "/aa/bb/test4384_1", "/aa/bb/test4384_2",
            "test4384_3", "test4384_4" };
