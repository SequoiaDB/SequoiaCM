...
public class CreateSche_deleteWs2365 extends TestScmBase {
	...
	private void test() throws Exception {
		...
		ScmCursor<ScmTaskBasicInfo> cursor1 = ScmSystem.Task.listTask(ssA,cond);
	...
	private void createScheduleTask() throws ScmException {
		...
		BSONObject queryCond = ScmQueryBuilder.start(ScmAttributeName.File.FILE_NAME).is(name).get();
