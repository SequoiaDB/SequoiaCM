...
/**
 * @Description SCM-4785 :: 更新桶状态为禁用（enable->suspended），指定文件物理删除
 * @author wuyan
 * @Date 2022.07.12
 * @version 1.00
 */
public class ScmFile4785 extends TestScmBase {
    private boolean runSuccess = false;
    private String bucketName = "bucket4785";
    private String fileName = "scmfile4785";
