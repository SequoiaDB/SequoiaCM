...
/**
 * @descreption SCM-4751 :: 桶开启版本控制，关联多版本同名文件到桶下
 * @author Zhaoyujing
 * @Date 2020/7/23
 * @updateUser
 * @updateDate
 ...
 * @version 1.0
 */
public class ScmFile4751 extends TestScmBase {
    private SiteWrapper site = null;
    private ScmSession session = null;
    private ScmWorkspace ws = null;
    private boolean runSuccess = false;
    private String bucketName = "bucket4751";
    private String keyName = "aa/bb/object4751";
    ...
    public void test() throws Exception {
        ...
        fileId = createScmFile( keyName, filePath );
        keyList.add( fileId );
        ...
        createScmFile( keyName, filePath );
    ...
    private void checkFileList() throws Exception {
        ...
        Assert.assertEquals( fileList.get( 0 ).getMajorVersion(), 1 );
    }
}
