...
/**
 * @description SCM-4083:创建断点文件后不续传，查询统计信息
 * @author ZhangYanan
 ...
 * @version v1.0
 */
public class StatisticsFile4083 extends TestScmBase {
    private File localPath = null;
    private boolean runSuccess = false;
    private SiteWrapper site = null;
    private WsWrapper wsp = null;
    private String fileName = "file4083";
    ...
    public void test() throws Exception {
        ScmFactory.BreakpointFile.createInstance( siteWorkspace, fileName );
