...
/**
 * @author fanyu
 * @Description:SCM-1935 :: 无权限普通用户获取属性
 * @Date:2018年7月5日
 * @version:1.0
 */
public class DefineAttr_Attr_Get1935 extends TestScmBase {
    private String attrname = "Get1935";
    private String desc = "Get1935";
    ...
    private String username = "Get1935";
    private String rolename = "Get1935";
    private String passwd = "1935";
