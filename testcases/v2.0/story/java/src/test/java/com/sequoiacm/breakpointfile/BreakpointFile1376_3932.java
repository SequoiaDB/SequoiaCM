...
/**
 * @description SCM-1376:不同用户断点续传文件 SCM-3932:不同用户断点续传文件
 * @author wuyan
 ...
 * @version v1.0
 */
public class BreakpointFile1376_3932 extends TestScmBase {
    ...
    private void test() throws ScmException, IOException, InterruptedException {

        // 创建断点文件,大小为1024*512
        BreakpointUtil.createBreakpointFile( ws1, filePath, fileName,
                1024 * 1024 * 12, ScmChecksumType.NONE );
        // 创建新用户密码
        this.createScmUser();
        // 使用新用户上传文件
