...
/**
 * @description SCM-5031:异步缓存当前版本文件
 * @author wuyan
 * @createDate 2020.07.30
 * @version v1.0
 */
public class ScmFile5031 extends TestScmBase {
    ...
    private String bucketName = "bucket5031";
    private String fileName = "fileVersion5031";
