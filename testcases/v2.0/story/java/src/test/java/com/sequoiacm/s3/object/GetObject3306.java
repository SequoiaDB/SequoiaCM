...
/**
 * @Descreption SCM-3306:指定ifNoneMatch和ifModifiedSince条件获取对象，不匹配ifModifiedSince（标准模式）
 * @Author YiPan
 * @Date 2020/3/11
 */
public class GetObject3306 extends TestScmBase {
    private boolean runSuccess = false;
    private String bucketName = "bucket3306";
    private String objectName = "object3306";
