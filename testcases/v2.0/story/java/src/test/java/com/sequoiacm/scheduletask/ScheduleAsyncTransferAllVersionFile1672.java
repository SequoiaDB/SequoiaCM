...
/**
 * @description SCM-1672:异步调度任务指定迁移所有版本文件
 * @author luweikang
...
public class ScheduleAsyncTransferAllVersionFile1672 extends TestScmBase {
    ...
    private void test() throws Exception {
        ...
        ScmTaskUtils.waitAsyncTaskFinished( wsM, fileId1, 1, 2 );
        ScmTaskUtils.waitAsyncTaskFinished( wsM, fileId1, 2, 2 );
        ScmTaskUtils.waitAsyncTaskFinished( wsM, fileId2, 1, 2 );
        ScmTaskUtils.waitAsyncTaskFinished( wsM, fileId2, 2, 2 );
        ScmTaskUtils.waitAsyncTaskFinished( wsM, fileId2, 3, 2 );
