...
/**
 * @Description SCM-4772 ::开启版本控制，指定版本号删除文件，该文件为删除标记(指定版本号为当前最新版本)
 * @author wuyan
 * @Date 2022.07.11
 * @version 1.00
 */
public class ScmFile4772A extends TestScmBase {
    private boolean runSuccess = false;
    private String bucketName = "bucket4772a";
    private String fileName = "scmfile4772a";
