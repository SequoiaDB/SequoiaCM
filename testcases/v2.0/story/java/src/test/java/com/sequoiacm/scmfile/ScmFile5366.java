 ...
 * @version 1.0
 */
public class ScmFile5366 extends TestScmBase {
    private boolean runSuccess = false;
    private SiteWrapper rootSite = null;
    private WsWrapper wsp = null;
    private ScmSession session = null;
    private String fileAuthor = "file5366_";
    ...
    public void test() throws Exception {
        ...
        es.addWorker( new ThreadUploadFileById( fileAuthor + 1 ) );
        es.addWorker( new ThreadUploadFileById( fileAuthor + 2 ) );
        es.run();

        Assert.assertEquals( threadSuccessNum, 1, "文件成功上传线程数量不为1!" );
