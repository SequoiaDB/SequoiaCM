...
//
///**
// * @Descreption SCM-6229:使用and组合多个not_contains检索文件
// * @Author YiPan
...
// * @Version
// */
//public class TagRetrieval6229 extends TestScmBase {
//    private String fileNameBase = "file6229_";
//    private String fileAuthor = "author6229";
//    private String wsName = "ws6229";
...
//        ScmTags file1Tag = TagRetrievalUtils.createTag( "tag1", "aBc" );
//        ScmTags file2Tag = TagRetrievalUtils.createTag( "tag1", "ABC" );
//        ScmTags file3Tag = TagRetrievalUtils.createTag( "tag1", "abc" );
//        ScmTags file4Tag = TagRetrievalUtils.createTag( "tag1" );
//
//        HashMap file1CusTomTag = TagRetrievalUtils
//                .createCustomTag( "{'tag1':'vtag1','abc':'vaBc'}" );
...
//        // 1. 字符串标签不包含abc and 自由标签不包含abc=vaBc的文件
//        ScmTagCondition tagCondition = ScmTagConditionBuilder.builder().tags()
//                .notContains( "abc" ).build();
//        ScmTagCondition customTagCondition = ScmTagConditionBuilder.builder()
//                .customTag().notContains( "abc", "vaBc" ).build();
//        ScmTagCondition cond = ScmTagConditionBuilder.builder()
//                .and( tagCondition, customTagCondition ).build();
//        String[] expFileList = { fileNameBase + 2, fileNameBase + 4 };
...
//        TagRetrievalUtils.checkSearchFileList( scmCursor, expFileList );
//
//        // 3. 字符串标签不包含*a*忽略大小写 and 自由标签不包含tag1=*a*的文件
//        tagCondition = ScmTagConditionBuilder.builder().tags()
//                .notContains( "*a*", true, true ).build();
//        customTagCondition = ScmTagConditionBuilder.builder().customTag()
//                .notContains( "tag1", "*a*", true, true ).build();
//        cond = ScmTagConditionBuilder.builder()
//                .and( tagCondition, customTagCondition ).build();
//        expFileList = new String[] {};
//        TagRetrievalUtils.waitFileTagBuild( ws, cond, expFileList.length );
