    ...
    private void createScheduleTask() {
        try {
            ...
            BSONObject cond = ScmQueryBuilder.start()
                    ...
                    .is( file.getMajorVersion() )
                    .and( ScmAttributeName.File.MINOR_VERSION )
                    .is( file.getMinorVersion() )
                    ...
                    .is( file.getCreateTime().getTime() )
                    .and( ScmAttributeName.File.UPDATE_USER )
                    .is( file.getUpdateUser() )
                    .and( ScmAttributeName.File.UPDATE_TIME )
                    .is( file.getUpdateTime().getTime() )
