...
/**
 * @description SCM-6091:禁用桶限额操作与删除对象并发
 * @author ZhangYanan
...
public class BucketQuota6091 extends TestScmBase {
    private boolean runSuccess = false;
    private String keyName = "object6091";
    private String bucketName = "bucket6091";
    ...
    public void test() throws Exception {
        ...
        t.addWorker( new DisableBucketQuotaThread() );
    ...
    private class DisableBucketQuotaThread {
        @ExecuteOrder(step = 1)
        private void run() throws Exception {
            try ( ScmSession session = ScmSessionUtils
                    .createSession( rootSite )) {
