...
/**
 * @Description SCM-3585:指定ifNoneMatch和ifModifiedSince条件复制对象，
 *              源对象不匹配ifModifiedSince
 * @author fanyu
 * @Date 2019.09.17
 */
public class CopyObject3585 extends TestScmBase {
    private boolean runSuccess = false;
    private AmazonS3 s3Client = null;
    private String srcBucketName = "bucket3585a";
    private String dstBucketName = "bucket3585b";
    private String keyName = "obj3585";
