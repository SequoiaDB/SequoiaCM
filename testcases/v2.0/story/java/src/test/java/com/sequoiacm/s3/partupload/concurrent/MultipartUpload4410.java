 ...
 * @version v1.0
 */
public class MultipartUpload4410 extends TestScmBase {
    private boolean runSuccess = false;
    private String bucketName = "bucket4410";
    private String keyName = "key4410";
    ...
    public void testUpload() throws Exception {
        ...
        for ( int i = 1; filePosition < fileSize; i++ ) {
            es.addWorker( new ThreadUploadPart4410( filePosition, i ) );
    ...
    class ThreadUploadPart4410 {
        private AmazonS3 s3Client = S3Utils.buildS3Client();
        private long filePosition;
        private int partNumber;

        public ThreadUploadPart4410( long filePosition, int partNumber )
                throws Exception {
