...
/**
 * @descreption SCM-5598:修改工作区下hdfs数据源配置验证
 * @author ZhangYanan
 * @date 2022/12/22
 * @updateUser
 * @updateDate
 ...
 * @version 1.0
 */
public class WorkSpaces5598 extends TestScmBase {
    private ScmSession session = null;
    private SiteWrapper site = null;
    private String wsName = "ws5598";
    private String dataPath = "dataPath5598";
    private String fileName = "file5598";
    ...
    public List< ScmDataLocation > prepareExpWsDataLocation()
        ...
        ScmHdfsDataLocation scmHdfsDataLocation = new ScmHdfsDataLocation(
                site.getSiteName() );
        scmHdfsDataLocation.setRootPath( dataPath );
