...
/**
 * @Description SCM-4770 :: 开启版本控制，带版本号删除最新版本文件
 * @author wuyan
 * @Date 2022.07.11
 * @version 1.00
 */
public class ScmFile4770 extends TestScmBase {
    private boolean runSuccess = false;
    private String bucketName = "bucket4770";
    private String fileName = "scmfile4770";
