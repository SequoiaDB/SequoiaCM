...
public class OverWriteFile2674 extends TestScmBase {
    ...
    private void setUp() throws IOException, ScmException {
        ...
        for ( int i = 0; i < fileNum; i++ ) {
            ...
            String filePath = localPath + File.separator + "localFile_C" + i
                    + ".txt";
            String updateFilePath = localPath + File.separator + "localFile_U"
                    + i + ".txt";
    ...
    private void test() throws Exception {
        for ( int i = 0; i < fileNum; i++ ) {
            ...
            scmFile.setContent( new FileInputStream(
                    new File( updateFilePathList.get( i ) ) ) );
            ...
            checkFile( actFile, fileId, fileName, newVal,
                    ( int ) new File( updateFilePathList.get( i ) ).length(),
    ...
    private void checkFile( ScmFile file, ScmId fileId, String fileName,
            String expVal, int expSize, String expFilePath, ScmTags expScmTags )
            throws Exception {
        try {
