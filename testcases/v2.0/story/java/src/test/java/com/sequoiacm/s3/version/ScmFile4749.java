...
/**
 * @descreption SCM-4749 :: 不开启版本控制，关联多版本文件到桶下
 * @author Zhaoyujing
 * @Date 2020/7/23
 * @updateUser
 * @updateDate
 ...
 * @version 1.0
 */
public class ScmFile4749 extends TestScmBase {
    private SiteWrapper site = null;
    private ScmSession session = null;
    private ScmWorkspace ws = null;
    private boolean runSuccess = false;
    private String bucketName = "bucket4749";
    private String keyName = "aa/bb/object4749";
