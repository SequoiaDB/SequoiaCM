...
/**
 * @description SCM-6089:开启限额，并发上传和删除对象未达到容量上限
 * @author ZhangYanan
...
public class BucketQuota6089 extends TestScmBase {
    private boolean runSuccess = false;
    private String keyName = "object6089";
    private String bucketName = "bucket6089";
    ...
    public void test() throws Exception {
        ...
        BucketQuotaUtils.checkQuotaInfo( quotaInfo, bucketName, maxObjectNum,
                maxObjectSize * fileSize, objectNum - 2,
    ...
    private class UploadFileThread {
        ...
        private void run() throws Exception {
            try ( ScmSession session = ScmSessionUtils
                ...
                ScmBucket bucket = ScmFactory.Bucket.getBucket( session,
                        bucketName );
                int keyNum = objectNum - 2;
                ScmFile file = bucket.createFile( keyName + keyNum );
