...
public class AuthWs_dir1732 extends TestScmBase {
    private static final Logger logger = Logger.getLogger(AuthWs_dir1732.class);
    ...
    private static final String[] DIR_PATH_ARRAY = { "/" + NAME + "_a/", "/" + NAME + "_a/" + NAME + "_a1/",
	    "/" + NAME + "_b/", "/" + NAME + "_c/", "/" + NAME + "_a/" + NAME + "_b1/" };
	...
	for (int i = DIR_PATH_ARRAY.length - 1; i >= 0; i--) {
	    try {
		System.out.println("i = " + i + ", dirPath = " + DIR_PATH_ARRAY[i]);
