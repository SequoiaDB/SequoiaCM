...
//
///**
// * @Descreption SCM-6216:文件并发添加多个不同字符串标签
// * @Author yangjianbo
...
// * @Version 1.0
// */
//public class TagRetrieval6216 extends TestScmBase {
//    private ScmSession session = null;
//    private SiteWrapper rootSite = null;
//    private WsWrapper wsp = null;
//    private BSONObject queryCond = null;
//    private String fileAuthor = "auth6216";
//    private int fileSize = 1024 * 1024;
//    private String filePath = null;
//    private File localPath = null;
//    private ScmWorkspace ws = null;
//    private String fileName = "file6216_";
...
//
//        // 启动多个并发线程，并发添加多个不同字符串标签
//        int threadNum = 5;
//        HashSet< String > set = new HashSet<>();
//        ThreadExecutor threadExec = new ThreadExecutor();
//        for ( int i = 0; i < threadNum; i++ ) {
//            threadExec.addWorker( new AddTagV2( scmId, "tag" + i ) );
//            set.add( "tag" + i );
//        }
//        threadExec.run();
//
