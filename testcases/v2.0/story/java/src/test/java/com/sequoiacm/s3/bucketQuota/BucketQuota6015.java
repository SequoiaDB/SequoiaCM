...
/**
 * @description SCM-6015:删除桶，检查清理限额表和额度统计表
 * @author ZhangYanan
...
public class BucketQuota6015 extends TestScmBase {
    private boolean runSuccess = false;
    private String keyName = "object6015";
    private String bucketName = "bucket6015";
