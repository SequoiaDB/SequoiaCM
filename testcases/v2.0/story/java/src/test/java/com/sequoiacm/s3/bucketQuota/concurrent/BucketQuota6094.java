...
/**
 * @description SCM-6094:取消限额同步与删除对象并发
 * @author ZhangYanan
...
public class BucketQuota6094 extends TestScmBase {
    private boolean runSuccess = false;
    private String keyName = "object6094";
    private String bucketName = "bucket6094";
    ...
    public void test() throws Exception {
        ...
        t.addWorker( new CancelSyncBucketQuotaThread() );
    ...
    private class CancelSyncBucketQuotaThread {
        @ExecuteOrder(step = 1)
        private void run() throws Exception {
            try ( ScmSession session = ScmSessionUtils
                    .createSession( rootSite )) {
