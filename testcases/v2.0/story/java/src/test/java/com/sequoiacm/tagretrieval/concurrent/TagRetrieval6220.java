...
//
///**
// * @Descreption SCM-6220:并发删除单个字符串标签和更新文件标签字段
// * @Author yangjianbo
...
// * @Version 1.0
// */
//public class TagRetrieval6220 extends TestScmBase {
//    private ScmSession session = null;
//    private SiteWrapper rootSite = null;
//    private WsWrapper wsp = null;
//    private BSONObject queryCond = null;
//    private String fileAuthor = "auth6220";
//    private int fileSize = 1024 * 1024;
//    private String filePath = null;
//    private File localPath = null;
//    private ScmWorkspace ws = null;
//    private String fileName = "file6220_";
...
//
//        // 启动两个并发线程，删除单个标签和更新文件标签字段，如线程a删除标签tag1；线程b更新文件标签字段为[tag1,tag2,tag3]
...
//        scmTags.addTags( set );
//        threadExec.addWorker( new DeleteTagV2( scmId, "tag1" ) );
...
//    }
//
//    public class DeleteTagV2 {
//        ScmId scmId;
//        String tag;
//
//        public DeleteTagV2( ScmId scmId, String tag ) {
//            this.scmId = scmId;
//            this.tag = tag;
//        }
//
