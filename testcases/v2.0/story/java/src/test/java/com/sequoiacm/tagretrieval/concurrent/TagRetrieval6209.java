...
//
///**
// * @Descreption SCM-6209:文件并发添加多个不同自由标签
// * @Author yangjianbo
...
// * @Version 1.0
// */
//public class TagRetrieval6209 extends TestScmBase {
//    private ScmSession session = null;
//    private SiteWrapper rootSite = null;
//    private WsWrapper wsp = null;
//    private BSONObject queryCond = null;
//    private String fileAuthor = "auth6209";
//    private int fileSize = 1024 * 1024;
//    private String filePath = null;
//    private File localPath = null;
//    private ScmWorkspace ws = null;
//    private String fileName = "file6209_";
...
//
//        // 启动多个并发线程，并发添加多个不同(key不同)自由标签
//        Map< String, String > expectedCustomTag = new TreeMap< String, String >();
//        ThreadExecutor threadExec = new ThreadExecutor();
//        int threadNum = 5;
//        for ( int i = 0; i < threadNum; i++ ) {
//            threadExec.addWorker( new AddTag( scmId, "key" + i, "value" + i ) );
//            expectedCustomTag.put( "key" + i, "value" + i );
//        }
//        threadExec.run();
//
//        // 查看添加结果
//        ScmFile instance = ScmFactory.File.getInstance( ws, scmId );
//        Assert.assertEquals( instance.getCustomTag().toString(),
...
//        String tagValue;
//
//        public AddTag( ScmId scmId, String tagKey, String tagValue ) {
//            this.scmId = scmId;
//            this.tagKey = tagKey;
...
//                        scmId );
//                instance.addCustomTag( tagKey, tagValue );
//            }
//        }
//    }
//}
