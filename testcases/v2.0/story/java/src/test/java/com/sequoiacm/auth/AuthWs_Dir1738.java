...
public class AuthWs_Dir1738 extends TestScmBase {
    ...
    private String[] dirpaths = {"/AuthWs_Dir1738_A", "/AuthWs_Dir1738_B", "/AuthWs_Dir1738_C"};
    ...
    private void prepare() throws Exception {
        try {
            ...
            for (String dirpath : dirpaths) {
                ...
                ScmResource dirrs = ScmResourceFactory.createDirectoryResource(wsp.getName(), dirpath);
                dirrsList.add(dirrs);
