...
/**
 * @FileName SCM-503: asyncTransfer参数校验
 * @Author fanyu
 * @Date 2017-06-28
 * @Version 1.00
 */
...
/*
 * ScmFactory.File.asyncTransfer接口参数校验： 1）有效参数：ws: 存在 fileid：存在 2）无效参数：ws:
 * 不存在、null fileid：不存在、null 2、检查校验结果
 */
public class AsyncTransfer_param_asyncTransfer503 extends TestScmBase {
    ...
    private String fileName = "AsyncTransferParamVerify503";
