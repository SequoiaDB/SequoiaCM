...
/**
 * @descreption SCM-4861 :: 禁用版本控制，并发获取不同版本同一文件
 * @author Zhaoyujing
 * @Date 2020/7/21
 * @updateUser
 * @updateDate
 ...
 * @version 1.0
 */
public class ScmFile4861 extends TestScmBase {
    private ScmSession session = null;
    private ScmWorkspace ws = null;
    private boolean runSuccess = false;
    private String bucketName = "bucket4861";
    private String keyName = "aa/bb/object4861";
    ...
    private void setUp() throws Exception {
        ...
        for ( int i = 0; i < versionNum; i++ ) {
            ScmFileUtils.createFile( bucket, keyName, filePathList.get( i ) );
        }
    ...
    private class GetFileThread extends ResultStore {
        ...
        public void run() throws Exception {
            ScmBucket bucket = ScmFactory.Bucket.getBucket( session,
                    bucketName );
            ScmFile scmFile = bucket.getFile( keyName, majorVersion, 0 );
