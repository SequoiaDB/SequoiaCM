...
/**
 * @FileName SCM-1231:创建调度任务，指定存活时间跨月
 * @Author huangxiaoni
 * @Date 2018-04-17
 * @Version 1.00
 */

public class CreateSche_copyCrossMonth1231 extends TestScmBase {
	private boolean runSuccess = false;	
	private SiteWrapper rootSite = null;
	private SiteWrapper branSite = null;
	private ScmSession session = null;
	private String wsName = "ws1231";
	
	private final static int fileNum = 10;
	private final static int fileSize = 100;
	private final static String name = "schetask1231";
	...
	private void test() throws Exception {
		...
		String maxStayTime = "" + cal.getActualMaximum(Calendar.DAY_OF_MONTH) + "d";
		try {
	...
	private void readyScmFile(int startNum, int endNum, Date dateStr) throws ScmException, ParseException {
		ScmSession ss = null;
		try {
