...
/**
 * @descreption SCM-5485:修改数据源分区规则与文件删除验证
 * @author ZhangYanan
 * @date 2022/11/29
 * @updateUser
 * @updateDate
 ...
 * @version 1.0
 */
public class WorkSpaces5485 extends TestScmBase {
    private ScmSession session = null;
    private SiteWrapper site = null;
    private String wsName = "ws5485";
    private String fileName1 = "file5485_1";
    private String fileName2 = "file5485_2";
