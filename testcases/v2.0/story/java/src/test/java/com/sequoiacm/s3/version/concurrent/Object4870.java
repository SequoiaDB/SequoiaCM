...
/**
 * @Description: SCM-4870 :: 开启版本控制，并发更新相同文件
 * @author wuyan
 * @Date 2022.07.20
 * @version 1.00
 */
public class Object4870 extends TestScmBase {
    ...
    private void checkResult() throws Exception {
        ...
        if ( actSize == fileSize ) {
            ...
            // 获取历史版本信息,校验结果
            getObjectAndCheckResult( historyVersion1, file2Md5, updateSize );
            getObjectAndCheckResult( historyVersion2, file0Md5, 0 );
        } else {
            ...
            // 获取历史版本信息,校验结果
            getObjectAndCheckResult( historyVersion1, file1Md5, fileSize );
            getObjectAndCheckResult( historyVersion2, file0Md5, 0 );
        }
    }
