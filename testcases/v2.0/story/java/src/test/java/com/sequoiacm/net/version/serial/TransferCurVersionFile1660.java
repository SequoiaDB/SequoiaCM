...
/**
 * test content:Transfer the current version file
 * testlink-case:SCM-1660
 * 
 * @author wuyan
 * @Date 2018.06.05
...
public class TransferCurVersionFile1660 extends TestScmBase {	
	...
	private void startTransferTaskByCurrentVerFile(ScmWorkspace ws, ScmSession session, ScopeType scopeType) throws Exception {
	...
	private void checkCurrentVerFileSiteAndDataInfo(ScmWorkspace ws, int currentVersion) throws Exception{
