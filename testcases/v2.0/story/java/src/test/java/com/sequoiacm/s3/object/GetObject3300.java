...
/**
 * @Descreption SCM-3300:指定ifUnModifiedSince和ifModifiedSince条件，不带versionId获取对象（标准模式）
 * @Author YiPan
 * @Date 2020/3/11
 */
public class GetObject3300 extends TestScmBase {
    private boolean runSuccess = false;
    private String bucketName = "bucket3300";
    private String objectName = "object3300";
