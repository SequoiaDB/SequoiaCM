...
public class BreakpointFile1392 extends TestScmBase{
	...
	private void test() throws Exception {
		try{
		BreakpointUtil.createBreakpointFile(ws, filePath, fileName, 1024*512, ScmChecksumType.ADLER32);
	...
	private void deleteBreakpointFile(String wsName, String filename, String errorType) throws Exception{
	...
	private void deleteBreakpointFile() throws Exception{
		...
		rest.connect(site.getSiteServiceName(), TestScmBase.scmUserName,TestScmBase.scmPassword);
		rest.setRequestMethod(HttpMethod.DELETE)
		.setApi("/breakpointfiles/"+fileName+"?workspace_name="+ws.getName())
		.exec();
