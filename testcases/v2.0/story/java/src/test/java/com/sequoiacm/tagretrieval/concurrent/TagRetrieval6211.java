...
//
///**
// * @Descreption SCM-6211:并发增加和删除单个自由标签
// * @Author yangjianbo
...
// * @Version 1.0
// */
//public class TagRetrieval6211 extends TestScmBase {
//    private ScmSession session = null;
//    private SiteWrapper rootSite = null;
//    private WsWrapper wsp = null;
//    private BSONObject queryCond = null;
//    private String fileAuthor = "auth6211";
//    private int fileSize = 1024 * 1024;
//    private String filePath = null;
//    private File localPath = null;
//    private ScmWorkspace ws = null;
//    private String fileName = "file6211_";
...
//
//        // 启动两个并发线程，并发添加和删除相同的自由标签
//        ThreadExecutor threadExec = new ThreadExecutor();
//        threadExec.addWorker( new AddTag( scmId, "key", "value" ) );
//        threadExec.addWorker( new DeleteTag( scmId, "key", "value" ) );
//        threadExec.run();
//
...
//        if ( customTag.size() != 0 ) {
//            Assert.assertEquals( customTag.get( "key" ), "value" );
//        }
//        runSuccess = true;
//    }
//
