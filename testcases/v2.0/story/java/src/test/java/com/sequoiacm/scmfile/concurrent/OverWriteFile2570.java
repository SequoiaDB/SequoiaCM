...
public class OverWriteFile2570 extends TestScmBase {
    ...
    private List<ScmBreakpointFile> breakpointFiles = new ArrayList<ScmBreakpointFile>();
    ...
    private void test() throws Exception {
        ...
        for (int i = 0; i < fileNum; i++) {
            ...
            checkFile(actFile, fileNamePre, fileSize + 1, updateFilePath, scmTags);
        }
        ...
        try {
            if (runSuccess || TestScmBase.forceClear) {
                ...
                for (ScmBreakpointFile breakpointFile : breakpointFiles) {
                    ScmFactory.BreakpointFile.deleteInstance(ws, breakpointFile.getFileName());
                }
                TestTools.LocalFile.removeFile(localPath);
            }
        } finally {
    ...
    private class BreakpointFile2ScmFile {
        ...
        public BreakpointFile2ScmFile(String fileName, ScmBreakpointFile scmBreakpointFile) {
            this.fileName = fileName;
    ...
    private ScmBreakpointFile prepareBreakpointFile(String fileName) throws IOException, ScmException {
    ...
    private void checkFile(ScmFile file, String expVal, int expSize, String expFilePath, ScmTags expScmTags) throws Exception {
        try {
            ...
            throw new Exception("fileName = " + file.getFileName() + ",fileId = " + file.getFileId().get(), e);
        }
    }
}
