...
/**
 * @Descreption SCM-5245:修改空间回收调度任务为迁移并清理任务
 * @Author YiPan
 ...
 * @Version
 */
public class SpaceRecycle5245 extends TestScmBase {
    private String fileName = "file5245_";
    private String taskName = "task5245";
    private String fileAuthor = "author5245";
    ...
    public void test() throws Exception {
        ...
        // 修改任务为迁移并清理任务，再次启动
        ScmScheduleMoveFileContent moveFileContent = new ScmScheduleMoveFileContent(
                rootSite.getSiteName(), branchSite.getSiteName(), "0d",
                queryCond, ScmType.ScopeType.SCOPE_CURRENT );
        sche.updateSchedule( ScheduleType.MOVE_FILE, moveFileContent );
        sche.enable();
        ScmScheduleUtils.waitForTask( sche, 2 );
