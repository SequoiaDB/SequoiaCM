...
/**
 * @Description SCM-3724:listTask接口指定limit参数获取task信息
 * @Author zhangyanan
 * @Date 2021.8.28
 ...
 * @version 1.00
 */
public class ListTask3724 extends TestScmBase {
    private int fileSize = 1024 * 100;
    private File localPath = null;
    private String filePath = null;
    private String fileName = "file3724";
