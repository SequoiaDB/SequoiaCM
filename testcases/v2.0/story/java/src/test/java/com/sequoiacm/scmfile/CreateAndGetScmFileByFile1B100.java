...
/**
 * @Testcase: SCM-100:文件大小<1M（如1B、100K）
 * @author huangxiaoni init
 * @date 2017.3.29
 */

public class CreateAndGetScmFileByFile1B100 extends TestScmBase {
    ...
    private String fileName = "scmfile100";
    ...
    private void test() {
        this.createScmFileByFile();
        this.getScmFileByFile();
        runSuccess = true;
    }
    ...
    private void createScmFileByFile() {
        try {
            // create file
