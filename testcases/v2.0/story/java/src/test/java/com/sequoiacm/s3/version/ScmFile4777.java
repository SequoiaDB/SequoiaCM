...
/**
 * @Description SCM-4777 :: 文件存在多个版本，版本控制由开启设置为禁用，不带版本号删除文件
 * @author wuyan
 * @Date 2022.07.12
 * @version 1.00
 */
public class ScmFile4777 extends TestScmBase {
    private boolean runSuccess = false;
    private String bucketName = "bucket4777";
    private String fileName = "scmfile4777";
