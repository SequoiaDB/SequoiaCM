...
/**
 * @description SCM-3709:创建相同调度任务指定相同region和不同zone
 * @author YiPan
 ...
 * @version v1.0
 */
public class CreateSchedule3709 extends TestScmBase {
    private int fileSize = 1024 * 100;
    private File localPath = null;
    private String filePath = null;
    private String tmpPath = null;
    private String fileName = "file3709";
    ...
    public void test() throws Exception {
        ...
        t.addWorker( new CreateSchedule( "2 * * * * ?", region, zone1 ) );
        t.addWorker( new CreateSchedule( "3 * * * * ?", region, zone2 ) );
        t.run();
        // 迁移任务
