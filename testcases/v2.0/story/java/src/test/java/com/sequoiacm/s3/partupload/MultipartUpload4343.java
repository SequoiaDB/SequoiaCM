...
/**
 * @description SCM-4343:开启分段检测，指定分段etag值不正确
 * @author ZhangYanan
...
public class MultipartUpload4343 extends TestScmBase {
    private boolean runSuccess = false;
    private String bucketName = "bucket4343";
    private String keyName = "key4343";
