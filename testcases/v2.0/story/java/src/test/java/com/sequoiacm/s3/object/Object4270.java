...
/**
 * @descreption SCM-4270 :: 批量关联文件时，部分文件已关联到相同桶中
 * @author Zhaoyujing
 * @Date 2020/5/26
 * @updateUser
 * @updateDate
 ...
 * @version 1.0
 */
public class Object4270 extends TestScmBase {
    private AmazonS3 s3Client = null;
    private SiteWrapper site = null;
    private ScmSession session = null;
    private ScmWorkspace ws = null;
    private boolean runSuccess = false;
    private String bucketName = "bucket4270";
    private String key = "aa/bb/object4270";
    ...
    public void test() throws ScmException, IOException {
        ...
        for ( int i = 0; i < objectNums / 10; i++ ) {
            ...
            ScmFactory.Bucket.attachFile( session, bucketName, attachId );
            attachedList.add( attachId.toString() );
        }

        // attach all files , include attached files
        List< ScmBucketAttachFailure > failures = ScmFactory.Bucket.attachFile(
                session, bucketName, keyList, ScmBucketAttachKeyType.FILE_ID );
