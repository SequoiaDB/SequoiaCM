...
/**
 * @description SCM-6149:分段上传后检查桶容量限额
 * @author ZhangYanan
...
public class BucketQuota6149 extends TestScmBase {
    private boolean runSuccess = false;
    private String keyName = "object6149";
    private String bucketName = "bucket6149";
    ...
    public void test1() throws ScmException, InterruptedException {
        ...
        try {
            String uploadId = PartUploadUtils.initPartUpload( s3Client,
                    bucketName, keyName + objectNum );
            List< PartETag > partEtags = PartUploadUtils.partUpload( s3Client,
                    bucketName, keyName + objectNum, uploadId,
                    new File( filePath3 ) );
