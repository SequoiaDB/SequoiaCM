...
/**
 * @descreption SCM-4752 :: 桶禁用版本控制，关联多版本文件到桶下
 * @author Zhaoyujing
 * @Date 2020/7/23
 * @updateUser
 * @updateDate
 ...
 * @version 1.0
 */
public class ScmFile4752 extends TestScmBase {
    private SiteWrapper site = null;
    private ScmSession session = null;
    private ScmWorkspace ws = null;
    private boolean runSuccess = false;
    private String bucketName = "bucket4752";
    private String keyName = "aa/bb/object4752";
    ...
    public void test() throws Exception {
        ...
        failures = ScmFactory.Bucket.attachFile( session, bucketName, keyList,
                ScmBucketAttachKeyType.FILE_NAME );
    ...
    private void checkFileList() throws Exception {
        ...
        S3Utils.checkFileContent( bucket.getFile( keyName ), updatePath,
                localPath );
    }
}
