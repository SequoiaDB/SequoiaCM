...
/**
 * @Descreption SCM-3299:指定ifNoneMatch和ifUnModifiedSince条件，不带versionId获取对象，不匹配ifNoneMatch（标准模式）
 * @Author YiPan
 * @Date 2020/3/11
 */
public class GetObject3299 extends TestScmBase {
    private boolean runSuccess = false;
    private String bucketName = "bucket3299";
    private String objectName = "object3299";
