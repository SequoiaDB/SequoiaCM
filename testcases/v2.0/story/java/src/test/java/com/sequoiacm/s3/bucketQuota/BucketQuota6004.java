...
/**
 * @description SCM-6004:暂停版本控制，上传对象（不存在null版本）后检查桶容量限额
 * @author ZhangYanan
...
public class BucketQuota6004 extends TestScmBase {
    private boolean runSuccess = false;
    private String keyName = "object6004";
    private String bucketName = "bucket6004";
