...
/**
 * @Description ScmDirUtils.java
 * @author wuyan
 * @date 2018.7.11
 */
public class ScmDirUtils extends TestScmBase {
	// 5min
	...
	public static ScmDirectory createDir(ScmWorkspace ws, String dirPath) throws ScmException {
	...
	public static void deleteDir(ScmWorkspace ws, String dirPath) {
		List<String> pathList = getSubPaths(dirPath);
	 ...
	 * @throws ScmException
	 */
	public static ScmId createFileWithDir( ScmWorkspace ws, String fileName, byte[] data, String authorName, 
	...
	public static ScmId createFileByStream( ScmWorkspace ws, String fileName, byte[] data ) throws ScmException  {		
		return createFileWithDir( ws, fileName, data, fileName,null);
	}
	 ...
	 * @throws ScmException
	 */
	public static ScmId createFileByFile( ScmWorkspace ws, String fileName, String filePath, String authorName ) throws ScmException  {		
		ScmFile file = ScmFactory.File.createInstance(ws);				
	 ...
	 * 
	 */
	public static ScmBreakpointFile createBreakpointFileByStream(ScmWorkspace ws, String fileName, byte[] data) throws ScmException{
	 ...
	 */
	public static void updateContentByFile( ScmWorkspace ws, String fileName,ScmId fileId, String filePath) throws ScmException{		
	 ...
	 */
	public static void updateContentWithDir(ScmWorkspace ws, ScmId fileId,
						byte[] updateData,ScmDirectory dir) throws ScmException{		
		ScmFile file = ScmFactory.File.getInstance(ws, fileId);
	 ...
	 */
	public static void CheckFileContentByStream(  ScmWorkspace ws, String fileName, 
			 	int version, byte[] filedata) throws Exception {
	 ...
	 * @throws IOException
	 */
	public static void checkScmFile(ScmWorkspace ws, String fileName, String filePath, String checkFilePath) throws ScmException, IOException{
	 ...
	 * @throws ScmException 
	 */
	public static void checkSite(ScmWorkspace ws, ScmId fileId, int major_version,SiteWrapper[] expSites) throws ScmException {
		...
		Assert.assertEquals(actIdList, expIdList,"actsiteId:"+actIdList.toString()
							+";expsiteId:"+expIdList.toString());		
	...
	public static void checkScheTaskFileSites(ScmWorkspace ws, List<ScmId> fileIds, int major_version,
			int startNum, int endNum, SiteWrapper[] expSites) throws Exception {
		checkScheTaskFileSites(ws, fileIds, major_version, startNum, endNum, expSites, defaultTimeOut);
	}
	
	public static void checkScheTaskFileSites(ScmWorkspace ws, List<ScmId> fileIds,int major_version, int startNum, int endNum, 
			SiteWrapper[] expSites, int timeOutSec) throws Exception {
		ScmId fileId = null;
	 ...
	 * @throws Exception
	 */
	public static void checkScheduleFileSite(ScmWorkspace ws, ScmId fileId, int major_version,SiteWrapper[] expSites) throws Exception{
		ScmFile file = ScmFactory.File.getInstance(ws, fileId, major_version, 0);
	 ...
	 * @throws Exception
	 */
	public static void waitAsyncTaskFinished(ScmWorkspace ws, ScmId fileId, int version,int expSiteNum) throws Exception {
	 ...
	 * @throws Exception
	 */
	public static void waitAsyncTaskFinished(ScmWorkspace ws, ScmId fileId,int majorVersion, int expSiteNum, int timeOutSec)
			throws Exception {
