...
/**
 * test content: update Content,and defineAttributes
 * testlink-case:SCM-1938
 * 
 * @author wuyan
 * @Date 2018.07.10
 * @version 1.00
...
public class UpdateContentAndDefineAttr1938 extends TestScmBase {
	...
	public Object[][] generatePageSize(){		
		String attrStr1 = "{name:'attr1938_string', display_name:'name1938_1', description:'Attribute 1938_1', type:'STRING', required:true}";
		String attrStr2 = "{name:'attr1938_date', display_name:'name1938_2', description:'Attribute 1938_2', type:'DATE', required:false}";
		String attrStr3 = "{name:'attr1938_double', display_name:'name1938_3', description:'中文', type:'DOUBLE', required:true}";
		String attrStr4 = "{name:'attr1938_int', display_name:'name1938_4', description:'test int', type:'INTEGER', required:true}";
		String attrStr5 = "{name:'attr1938_bool', display_name:'name1938_5', description:'test bool', type:'BOOLEAN', required:true}";
		return new Object[][]{
			//the parameter : className / attibutes	/ attrValue		
			new Object[]{"class1938_1", attrStr1, "test1938"},
			new Object[]{"class1938_2", attrStr2, "2018-07-10-01:01:00.000"},
	...
	@Test(groups = { "oneSite", "twoSite", "fourSite"},dataProvider = "testProvider")
	private void test( String className, String attrStr, Object value) throws Exception {		
	...
	private void updateContentAndSetAttr(String attrStr,Object value,String className) throws Exception{
		//update content
		...
		ScmClass scmClass = ScmFactory.Class.createInstance(ws, className, "i am a class1938");
