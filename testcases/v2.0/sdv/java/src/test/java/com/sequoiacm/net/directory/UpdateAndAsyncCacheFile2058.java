...
public class UpdateAndAsyncCacheFile2058 extends TestScmBase {
	...
	private void test() throws Exception {
		...
		fileId = ScmDirUtils.createFileWithDir(wsS, fileName, fileData, author, scmDir);
		...
		VersionUtils.CheckFileContentByStream(  wsS, fullPath+fileName, currentVersion, updateData );
