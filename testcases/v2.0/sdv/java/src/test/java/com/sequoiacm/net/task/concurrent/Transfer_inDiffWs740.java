...
public class Transfer_inDiffWs740 extends TestScmBase {
    ...
    private void writeFile( String wsName, List< ScmId > fileIdList )
            throws ScmException {
    ...
    private class StartTransferTaskInWs3 extends TestThreadBase {
        ...
        public void exec() throws Exception {
            ...
            try {
                ...
                SiteWrapper[] expSiteList = { sourceSite, targetSite };
                ScmFileUtils.checkMetaAndData( ws_TList.get( 2 ), fileIdList,
                        expSiteList, localPath, filePath );
            } finally {
                if ( sessionA != null ) {
                    sessionA.close();
