...
public class BraekFile2ScmFileWithDir2068 extends TestScmBase {
	...
	private void testDirHasSame() throws Exception {
		...
		ScmBreakpointFile breakpointFile = createBreakpointFile(name + "_1", filePath);
		...
		ScmBreakpointFile file = ScmFactory.BreakpointFile.getInstance(ws, name + "_1");
	...
	private void testOtherDirHasSame() throws Exception {
		// create file in dir
		ScmDirectory dir = ScmFactory.Directory.getInstance(ws, "/2066_A/2066_B/2066_C");
		createFile(null, filePath, name + "_2", dir);

		// breakpointFile transfer to ScmFile
		ScmBreakpointFile breakpointFile = createBreakpointFile(name + "_2", filePath);
	...
	private void test() throws Exception {
		// breakpointFile transfer to ScmFile
		ScmBreakpointFile breakpointFile = createBreakpointFile(name + "_3", filePath);
		ScmDirectory dir1 = ScmFactory.Directory.getInstance(ws, dirPath);
	...
	private ScmId createFile(ScmBreakpointFile breakpointFile, String filePath, String name, ScmDirectory dir)
			throws ScmException {
