...
public class FileOprBySameDir2206 extends TestScmBase {
	...
	private void createFile( ScmWorkspace ws, byte[] data, ScmDirectory dir,int fileNums ) throws ScmException  {		
	...
	private void checkFileNumByDir(ScmWorkspace ws) throws ScmException, InterruptedException{
	...
	private void checkFileDir(ScmWorkspace ws, ScmId fileId, ScmDirectory scmDir) throws ScmException{
		ScmFile file = ScmFactory.File.getInstance(ws, fileId);		
