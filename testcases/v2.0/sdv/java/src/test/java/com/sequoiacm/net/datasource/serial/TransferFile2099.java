...
public class TransferFile2099 extends TestScmBase {
	...
	private void setUp() throws IOException, ScmException {
		...
		if ( dbDataSoureCount == siteList.size() - 1 ) {				
			throw new SkipException("target and source site are connected to same datasourse, skip!");
		}
	...
	private void startTransferTaskByFile(ScmWorkspace ws, ScmSession session) throws Exception {		
		...
		taskId = ScmSystem.Task.startTransferTask(ws, taskCondition, ScopeType.SCOPE_CURRENT,targetSite.getSiteName());
