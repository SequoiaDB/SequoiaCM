...
public class BatchAttachFileWithDiffDir2071 extends TestScmBase {
	...
	private void test() throws Exception {
		...
		ScmFile file = ScmFactory.File.getInstance(ws, fileIdList.get(index));
	...
	private ScmId createFile(String filePath, String name, ScmDirectory dir) throws ScmException {
