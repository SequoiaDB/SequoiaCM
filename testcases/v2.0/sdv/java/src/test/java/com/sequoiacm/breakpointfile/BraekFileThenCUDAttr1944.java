...
public class BraekFileThenCUDAttr1944 extends TestScmBase {
	...
	private void breakpointFile2ScmFile(ScmBreakpointFile breakpointFile, String name, ScmClassProperties properties)
			throws ScmException {
	...
	private void updateFile(ScmId fileId, ScmClassProperties properties) throws ScmException {
	...
	private ScmClass createClass(String name) throws ScmException {
		ScmClass class1 = ScmFactory.Class.createInstance(ws, name, name + "_desc");
		return class1;
	}

	private void classAttachAttr(ScmClass class1, ScmAttribute attr) throws ScmException {
		class1.attachAttr(attr.getId());
	}

	private void check(ScmId fileId, ScmClassProperties properties) throws ScmException {
		ScmFile file = ScmFactory.File.getInstance(ws, fileId);
