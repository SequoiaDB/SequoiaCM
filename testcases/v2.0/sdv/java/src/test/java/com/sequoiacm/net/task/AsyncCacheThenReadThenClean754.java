...
public class AsyncCacheThenReadThenClean754 extends TestScmBase {
	...
	private void cache() throws Exception {
		...
		try {
			ScmWorkspace ws1 = ScmFactory.Workspace.getWorkspace(ws_T.getName(), sessionT);
	...
	private void checkResult(ScmFile file, ScmId fileId, String wsName, String downloadPath) {
		try {
