...
/**
 * test content:create a file under a dir,than update Content of the file, than ayncCache the current version file
...
public class UpdateAndAsyncCacheFile2058 extends TestScmBase {
	...
	private String fullPath = dirBasePath + "/2058_a/2058_b/2058_c/2058_e/2058_f/";
	...
	private void test() throws Exception {
		...
		fileId = ScmDirUtils.createFileWithDir(wsA, fileName, fileData, author, scmDir);
		...
		VersionUtils.CheckFileContentByStream(  wsA, fullPath+fileName, currentVersion, updateData );
	...
	private void asyncCacheCurrentVersionFile(ScmWorkspace ws, int majorVersion) throws Exception {	
			// cache
	...
	private void checkFileDir(ScmWorkspace ws, ScmDirectory scmDir) throws ScmException{
