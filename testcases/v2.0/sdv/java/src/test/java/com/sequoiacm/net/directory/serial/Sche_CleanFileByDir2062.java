...
public class Sche_CleanFileByDir2062 extends TestScmBase {	
	...
	private void test() throws Exception {	
		...
		VersionUtils.checkScheTaskFileSites(wsC, fileIdList1,currentVersion,expCurSiteList1);
		SiteWrapper[] expCurSiteList2 = { lastSite ,cleanSite };
		VersionUtils.checkScheTaskFileSites(wsL, fileIdList2,currentVersion,expCurSiteList2);			
		runSuccess = true;
	}
