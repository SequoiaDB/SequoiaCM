...
/**
 * test content: create file and read file from different site ,and the sites connected to different datasource
...
public class WriteAndReadFromDiffDatasource2097 extends TestScmBase {	
	...
	private void test( ) throws Exception {	
		fileId = VersionUtils.createFileByStream(wsB, fileName, writeData, authorName);
		int majorVersion = 1;
		VersionUtils.CheckFileContentByStream(wsA, fileName, majorVersion, writeData);
		runSuccess = true;
	}
