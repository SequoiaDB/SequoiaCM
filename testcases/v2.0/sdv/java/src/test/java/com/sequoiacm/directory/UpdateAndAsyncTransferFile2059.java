...
public class UpdateAndAsyncTransferFile2059 extends TestScmBase {
	...
	private void test() throws Exception {			
		fileId = ScmDirUtils.createFileWithDir(wsA, fileName, writeData, authorName, scmDir1);
		...
		VersionUtils.CheckFileContentByStream(  wsA, fullPath2 + fileName, currentVersion, updateData );		
		...
		VersionUtils.CheckFileContentByStream(  wsA, fullPath2 + fileName, historyVersion, writeData );
		
		//check the file dir attribute 
		checkFileDirAttr(wsA, scmDir1,scmDir2, currentVersion,historyVersion);		
