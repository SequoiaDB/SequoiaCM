...
public class CUFileUnderDiffDataSource2100 extends TestScmBase {
	...
	private void setUp() throws IOException, ScmException {
		...
		filePath2 = localPath + File.separator + "localFile_" + fileSize/2 + ".txt";
	...
	private ScmId createFile(ScmWorkspace ws,String name, String filePath) throws ScmException {
	...
	private void updateFile(ScmWorkspace ws,ScmId fileId, String filePath) throws ScmException {
	...
	private void checkResult(ScmId fileId,ScmWorkspace ws,int currentVerion) throws Exception{
		...
		//check content
		VersionUtils.CheckFileContentByFile(ws, fileId,currentVerion ,filePath2, localPath);
	}
}