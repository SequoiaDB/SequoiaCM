...
public class ScmConfigPropsModifier {
    ...
    public boolean modifyPropsFile(Map<String, String> updateProps) throws ScmOmServerException {
        // e.g: configFilePath = /scm/conf/application.properties

        // create a new props file: /scm/conf/newApplication.properties.tmp
        boolean isDifferentFromOld = createNewAppPropsTmpFile(updateProps, new ArrayList<String>());
    ...
    private File backupPropsFile() throws ScmOmServerException {
    ...
    private void renameFile(File oldFile, File newFile) throws ScmOmServerException {
    ...
    private boolean createNewAppPropsTmpFile(Map<String, String> updateProps,
            List<String> deleteProps) throws ScmOmServerException {
