...
public class ScmToolsDefine {
    ...
    public static class FILE_NAME {
        ...
        // jarName prefix
        public static final String OM_SERVER_JAR_NAME_PREFIX = "sequoiacm-om-omserver-";
    ...
    public static class NODE_TYPE {
        public static final String OM_SERVER_NUM = "1";
        public static final String OM_SERVER_STR = FILE_NAME.OM_SERVER;
