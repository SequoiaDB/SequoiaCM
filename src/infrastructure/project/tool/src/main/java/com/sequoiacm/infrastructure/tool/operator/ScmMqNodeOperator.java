...
public class ScmMqNodeOperator extends DefaultNodeOperator {
    public ScmMqNodeOperator() throws ScmToolsException {
        super(new ScmNodeType(ScmNodeTypeEnum.MQSERVER, ScmServerScriptEnum.MQSERVER));
    }
}
