...
public class ScmTraceNodeOperator extends DefaultNodeOperator {
    public ScmTraceNodeOperator() throws ScmToolsException {
        super(new ScmNodeType(ScmNodeTypeEnum.SERVICETRACE, ScmServerScriptEnum.SERVICETRACE));
    }
}
