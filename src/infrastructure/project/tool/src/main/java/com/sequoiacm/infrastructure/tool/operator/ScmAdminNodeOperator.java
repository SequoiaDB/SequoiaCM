...
public class ScmAdminNodeOperator extends DefaultNodeOperator {
    public ScmAdminNodeOperator() throws ScmToolsException {
        super(new ScmNodeType(ScmNodeTypeEnum.ADMINSERVER, ScmServerScriptEnum.ADMINSERVER));
    }
}
