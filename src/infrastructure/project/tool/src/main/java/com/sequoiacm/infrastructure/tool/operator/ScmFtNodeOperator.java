...
public class ScmFtNodeOperator extends DefaultNodeOperator {
    public ScmFtNodeOperator() throws ScmToolsException {
        super(new ScmNodeType(ScmNodeTypeEnum.FULLTEXTSERVER, ScmServerScriptEnum.FULLTEXTSERVER));
    }
}
