...
public class ScmSchNodeOperator extends DefaultNodeOperator {
    public ScmSchNodeOperator() throws ScmToolsException {
        super(new ScmNodeType(ScmNodeTypeEnum.SCHEDULESERVER, ScmServerScriptEnum.SCHEDULESERVER));
    }
}
