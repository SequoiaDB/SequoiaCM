...
public class ScmCommandUtil {
    ...
    public static void addTypeOption(Options ops, ScmHelpGenerator hp, boolean isRequired,
            boolean haveAllOpDesc) throws ScmToolsException {
        StringBuilder typeOptDesc = new StringBuilder();
        if (haveAllOpDesc) {
            typeOptDesc.append("specify node type, arg:[ 0 | 1 | 2 | 3 | 20 | 21 ],\r\n");
            typeOptDesc.append("0:all, ");
        }else {
            typeOptDesc.append("specify node type, arg:[ 1 | 2 | 3 | 20 | 21 ],\r\n");
        }
        typeOptDesc.append("1:service-center, 2:gateway, 3:auth-server\r\n");
        typeOptDesc.append("20:service-trace, 21:admin-server");
    ...
    public static int getTimeout(CommandLine commandLine, String timeoutOptName) throws ScmToolsException {
