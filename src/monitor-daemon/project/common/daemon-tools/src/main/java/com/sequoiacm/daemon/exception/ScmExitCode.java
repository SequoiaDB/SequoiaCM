package com.sequoiacm.daemon.exception;
...
public class ScmExitCode {
    ...
    public static int NOT_SUITABLE_PERIOD = 41;
    public static int DAEMON_DIFF_USER = 42;
    public static int NODE_INFO_EXIST = 43;
