...
public class ScmToolsDefine {
    ...
    public static class FILE_NAME {
        ...
        // jarName prefix
        public static final String MQ_SERVER_JAR_NAME_PREFIX = "sequoiacm-mq-server-";
    ...
    public static class NODE_TYPE {
        public static final String MQ_SERVER_NUM = "1";
        public static final String MQ_SERVER_STR = FILE_NAME.MQ_SERVER;
