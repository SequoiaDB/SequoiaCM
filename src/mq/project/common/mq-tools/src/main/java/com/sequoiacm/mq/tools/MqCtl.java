...
import com.sequoiacm.mq.tools.command.ScmListToolImpl;
import com.sequoiacm.mq.tools.command.ScmStartToolImpl;
import com.sequoiacm.mq.tools.command.ScmStopToolImpl;
import com.sequoiacm.mq.tools.command.ScmTool;
import com.sequoiacm.mq.tools.common.ScmCommon;
import com.sequoiacm.mq.tools.common.ScmHelper;
...
public class MqCtl {
    private static Logger logger = LoggerFactory.getLogger(MqCtl.class.getName());
    public static String helpMsg = "usage: mqctl <subcommand> [options] [args]" + "\r\n"
            + "Type 'mqctl help [subcommand]' for help on a specific subcommand" + "\r\n"
            + "Type 'mqctl --version' to see the program version" + "\r\n" + "\r\n"
    ...
    private static ScmTool getInstanceByToolName(String toolName) throws ScmToolsException {
        ...
        if (toolName.equals("start")) {
            ...
            instance = new ScmHelpToolImpl(MqCtl.class, false);
        }
        else if (toolName.equals("helpfull")) {
            instance = new ScmHelpToolImpl(MqCtl.class, true);
        }
        else {
        }
        return instance;
