...
import com.sequoiacm.mq.client.core.MessageSeserializer;
...
public class Test implements ApplicationRunner {
    ...
    private void testMsg() throws MqException {
        ...
        ProducerClient<BSONObject> producer = producerMgr.createClient("topic1",
                new MessageSeserializer<BSONObject>() {
        ...
        producer.putMsg("k2", b);
        producer.putMsg("k3", b);
        producer.putMsg("k4", b);
        producer.putMsg("k5", b);
