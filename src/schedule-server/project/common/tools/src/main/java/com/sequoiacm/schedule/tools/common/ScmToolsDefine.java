...
public class ScmToolsDefine {
    ...
    public static class FILE_NAME {
        ...
        public static final String SCHEDULE_SEVER = "schedule-server";
        ...
        // jarName prefix
        public static final String SCHEDULE_SERVER_JAR_NAME_PREFIX = "sequoiacm-schedule-server-";
    ...
    public static class NODE_TYPE {
        public static final String SCHEDULE_SERVER_NUM = "1";
        public static final String SCHEDULE_SERVER_STR = FILE_NAME.SCHEDULE_SEVER;
