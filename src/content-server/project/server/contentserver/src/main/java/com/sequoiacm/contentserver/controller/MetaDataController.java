...
public class MetaDataController {
    ...
    public MetadataClass getClassInfo(
        ...
        RestUtils.checkWorkspaceName(workspaceName);
        ScmUser user = (ScmUser) auth.getPrincipal();
        return this.metadataService.getClassInfoWithAttr(user, workspaceName, classId);
    }
    ...
    public MetadataClass getClassInfoByName(
        ...
        RestUtils.checkWorkspaceName(workspaceName);
        ScmUser user = (ScmUser) auth.getPrincipal();
        return this.metadataService.getClassInfoWithAttrByName(user, workspaceName, className);
    }
    ...
    public void deleteClass(@RequestParam(CommonDefine.RestArg.WORKSPACE_NAME) String workspaceName,
        ...
        RestUtils.checkWorkspaceName(workspaceName);
        ScmUser user = (ScmUser) auth.getPrincipal();
        this.metadataService.deleteClass(user, workspaceName, classId);
    }
    ...
    public void deleteClassByName(
        ...
        RestUtils.checkWorkspaceName(workspaceName);
        ScmUser user = (ScmUser) auth.getPrincipal();
        this.metadataService.deleteClassByName(user, workspaceName, className);
    }
    ...
    public List<MetadataAttr> listAttr(
        ...
        RestUtils.checkWorkspaceName(workspaceName);
        ScmUser user = (ScmUser) auth.getPrincipal();
        return this.metadataService.listAttr(user, workspaceName, filter);
    }
    ...
    public MetadataAttr getAttrInfo(
        ...
        ScmUser user = (ScmUser) auth.getPrincipal();
        RestUtils.checkWorkspaceName(workspaceName);
        return this.metadataService.getAttrInfo(user, workspaceName, attrId);
    }
    ...
    public void deleteAttr(@RequestParam(CommonDefine.RestArg.WORKSPACE_NAME) String workspaceName,
        ...
        this.metadataService.deleteAttr(user, workspaceName, attrId);
    }
    ...
    private void checkAttrUpdateInfo(String wsName, String attrId, BSONObject updateInfoObj)
        ...
        if (objFields.size() != 1) {
            throw new ScmInvalidArgumentException(
                    "invlid argument,updates only one property at a time:updator=" + updateInfoObj);
            /*
             * if ((!objFields.contains("type")) || (!objFields.contains("check_rule"))) {
             * throw new ScmInvalidArgumentException(
        ...
        /*
         * if (updateInfoObj.containsField(FieldName.Attribute.FIELD_TYPE)) { String
         * type = (String) checkExistString(updateInfoObj,
         * FieldName.Attribute.FIELD_TYPE); attrType = AttributeType.getType(type); if
         * (attrType == AttributeType.UNKOWN_TYPE) { throw new
