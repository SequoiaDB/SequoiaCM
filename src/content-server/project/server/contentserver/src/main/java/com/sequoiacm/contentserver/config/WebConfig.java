...
import com.sequoiacm.contentserver.common.BSONObjectJsonSerializer;
...
import com.sequoiacm.contentserver.model.MetadataAttrJsonSerializer;
import com.sequoiacm.contentserver.model.MetadataClass;
import com.sequoiacm.contentserver.model.MetadataClassJsonSerializer;
import com.sequoiacm.contentserver.model.serial.gson.BSONObjectGsonTypeAdapter;
import com.sequoiacm.contentserver.model.serial.gson.BreakpointFileGsonTypeAdapter;
import com.sequoiacm.contentserver.model.serial.gson.MetadataAttrGsonTypeAdapter;
import com.sequoiacm.contentserver.model.serial.gson.MetadataClassGsonTypeAdapter;
...
public class WebConfig extends WebMvcConfigurerAdapter {
    ...
    private void configScmGsonConverter(List<HttpMessageConverter<?>> converters) {
        ScmGsonHttpMessageConverter converter = ScmGsonHttpMessageConverter.start()
                ...
                .registerTypeAdapter(BSONObject.class, new BSONObjectGsonTypeAdapter()).build();
