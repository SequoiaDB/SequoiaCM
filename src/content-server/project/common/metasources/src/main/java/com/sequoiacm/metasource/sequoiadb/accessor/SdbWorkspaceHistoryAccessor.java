...
public class SdbWorkspaceHistoryAccessor extends SdbMetaAccessor implements MetaWorkspaceAccessor {
    private static final Logger logger = LoggerFactory.getLogger(SdbWorkspaceHistoryAccessor.class);

    public SdbWorkspaceHistoryAccessor(SdbMetaSource metasource, String csName, String clName,
