...
public class SdbDataSourceWrapper {
    ...
    public SdbDataSourceWrapper(List<String> urlList, String user, String passwd,
            ConfigOptions connConf, DatasourceOptions datasourceConf) throws SdbMetasourceException {
        try {
    ...
    public Sequoiadb getConnection() throws SdbMetasourceException {
        ...
        try {
            ...
            throw new SdbMetasourceException(SDBError.SDB_INTERRUPT.getErrorCode(), "interrupted", e);
        }
    }
