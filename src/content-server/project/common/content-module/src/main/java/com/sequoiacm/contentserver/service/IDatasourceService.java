...
public interface IDatasourceService {
    ...
    DatasourceReaderDao readData(String workspaceName, String dataId, int dataType, long createTime,
            int readflag, OutputStream os, int wsVersion) throws ScmServerException;

    BSONObject getDataInfo(String workspaceName, ScmDataInfo dataInfo)
            throws ScmServerException;

    void createDataInLocal(String wsName, ScmDataInfo dataInfo) throws ScmServerException;

    void createDataInLocal(String wsName, ScmDataInfo dataInfo, InputStream is) throws ScmServerException;
    ...
    ScmDataReader getScmDataReader(String wsName, String dataId, int dataType, long createTime, int wsVersion)
    ...
    ScmSeekableDataWriter getScmSeekableDataWriter(String wsName, String dataId, int dataType,
            long createTime, int wsVersion) throws ScmServerException;
