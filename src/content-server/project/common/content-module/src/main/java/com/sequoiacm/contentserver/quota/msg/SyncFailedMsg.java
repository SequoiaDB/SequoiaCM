...
public class SyncFailedMsg implements QuotaSyncMsg {

    private String type;
    private String name;
    private int syncRoundNumber;

    public SyncFailedMsg(String type, String name, int syncRoundNumber) {
        this.type = type;
        this.name = name;
    ...
    public String toString() {
        return "SyncFailedMsg{" + "type='" + type + '\'' + ", name='" + name + '\''
