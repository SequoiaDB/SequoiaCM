...
public class ScmExecutorWrapper {
    ...
    public ScmExecutorWrapper(String installPath) throws ScmToolsException {
    ...
    public void startNode(int port) throws ScmToolsException {
        String nodeConfPath = getNodeConfPathCheck(port);
        try {
            ...
            String logPath = installPath + File.separator
            ...
            String jarPath = ScmContentCommon.getContentServerJarPath(installPath);
            String workPath = installPath + File.separator
                    + ScmServerScriptEnum.CONTENTSERVER.getDirName() + File.separator + "lib";
    ...
    public int getNodePid(int port) throws ScmToolsException {
        String confOfPort = getNodeConfPathCheck(port);
    ...
    public String getNodeConfPathCheck(int port) throws ScmToolsException {
    ...
    private void scanConfDir() {
        ...
        String confPath = ScmContentCommon.getScmConfAbsolutePath(installPath);
