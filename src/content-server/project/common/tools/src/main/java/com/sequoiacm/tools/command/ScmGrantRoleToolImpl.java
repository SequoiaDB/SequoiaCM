...
public class ScmGrantRoleToolImpl extends ScmTool {
    ...
    public ScmGrantRoleToolImpl() throws ScmToolsException {
        ...
        ops.addOption(hp.createOpt(null, LONG_OP_PRIVILEGE,
                "granted privilege. all supported value:\n"
    ...
    public void process(String[] args) throws ScmToolsException {
        ...
        grantRole(roleName, resourceType, resource, privilege, gatewayUrl);
    ...
    private void grantRole(String roleName, String resourceType, String resource, String privilege,
            String gatewayUrl) throws ScmToolsException {
        ScmSession ss = null;
        try {
            ...
            logger.error("grant role failed:url={},admin={},newRole={}", gatewayUrl, adminUser,
                    roleName, e);
