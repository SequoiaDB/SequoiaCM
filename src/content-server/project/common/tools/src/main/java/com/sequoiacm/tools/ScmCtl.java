...
public class ScmCtl {
    ...
    private static ScmTool getInstanceByToolName(String toolName) throws ScmToolsException {
        ...
        if (toolName.equals("start")) {
            ScmCommon.setLogAndProperties(ScmCommon.START_LOG_PATH, ScmCommon.LOG_FILE_STARTNODE);
            instance = new ScmStartToolImpl();
        }
        else if (toolName.equals("stop")) {
            ScmCommon.setLogAndProperties(ScmCommon.STOP_LOG_PATH, ScmCommon.LOG_FILE_STOPNODE);
            instance = new ScmStopToolImpl();
        }
        else if (toolName.equals("list")) {
            instance = new ScmListToolImpl();
        }
        else if (toolName.equals("reloadbizconf")) {
            instance = new ScmReloadBizConfToolImpl();
        }
        else if (toolName.equals("help")) {
            instance = new ScmHelpToolImpl(ScmCtl.class, false);
        }
        else if (toolName.equals("helpfull")) {
            instance = new ScmHelpToolImpl(ScmCtl.class, true);
        }
        return instance;
    }
