...
import com.sequoiacm.config.tools.command.ScmListToolImpl;
import com.sequoiacm.config.tools.command.ScmStartToolImpl;
import com.sequoiacm.config.tools.command.ScmStopToolImpl;
...
public class ConfCtl {
    ...
    private static ScmTool getInstanceByToolName(String toolName) throws ScmToolsException {
        ...
        if (toolName.equals("start")) {
            ...
            instance = new ScmHelpToolImpl(ConfCtl.class, false);
        }
        else if (toolName.equals("helpfull")) {
            instance = new ScmHelpToolImpl(ConfCtl.class, true);
        }
        else {
            // TODO:
        }
