...
public class ScmToolsDefine {
    ...
    public static class FILE_NAME {
        ...
        // jarName prefix
        public static final String CONFIG_SERVER_JAR_NAME_PREFIX = "sequoiacm-config-server-";
    ...
    public static class NODE_TYPE {
        public static final String CONFIG_SERVER_NUM = "1";
        public static final String CONFIG_SERVER_STR = FILE_NAME.CONFIG_SERVER;
