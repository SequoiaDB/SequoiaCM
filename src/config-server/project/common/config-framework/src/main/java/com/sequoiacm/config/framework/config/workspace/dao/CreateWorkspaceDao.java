...
public class CreateWorkspaceDao {
    ...
    private WorkspaceConfig createWorkspace(WorkspaceConfig wsConfig) throws ScmConfigException {
        ...
        try {
            ...
            versionDao.createVersion(ScmBusinessTypeDefine.META_DATA, wsConfig.getWsName(),
                    transaction);
    ...
    private ScmConfEvent createWorkspaceEvent(String wsName) throws ScmConfigException {
        WorkspaceNotifyOption notifyOption = new WorkspaceNotifyOption(wsName, 1);
        return new ScmConfEvent(ScmBusinessTypeDefine.WORKSPACE, EventType.CREATE, notifyOption);
    }
