package com.sequoiacm.config.framework.config.metadata.operator;

import java.util.List;

import com.sequoiacm.config.framework.config.metadata.dao.MetaDataConfCreatorDao;
import com.sequoiacm.config.framework.config.metadata.dao.MetaDataConfDeletorDao;
import com.sequoiacm.config.framework.config.metadata.dao.MetaDataConfUpdatorDao;
...
import com.sequoiacm.infrastructure.config.core.msg.metadata.MetaDataConfigUpdater;
...
public class MetaDataConfOperator implements ScmConfOperator {
    ...
    @Override
    public ScmConfOperateResult updateConf(ConfigUpdater configUpdater) throws ScmConfigException {
        MetaDataConfigUpdater metaDataUpdator = (MetaDataConfigUpdater) configUpdater;
