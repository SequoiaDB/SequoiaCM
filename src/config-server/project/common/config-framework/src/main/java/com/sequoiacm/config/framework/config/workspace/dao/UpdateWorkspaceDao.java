...
public class UpdateWorkspaceDao {
    ...
    public ScmConfOperateResult update(WorkspaceUpdater updator) throws ScmConfigException {
        ...
        try {
            ...
            else if (updator.getEnableDirectory() != null) {
                Boolean isEnableDirectory = updator.getEnableDirectory();
            ...
            WorkspaceConfig wsConfig = (WorkspaceConfig) configEntityTranslator
                    .fromConfigBSON(ScmBusinessTypeDefine.WORKSPACE, newWsRecord);
    ...
    private ScmConfEvent createEvent(WorkspaceConfig wsConfig, Integer newVersion) {
        WorkspaceNotifyOption notifycation = new WorkspaceNotifyOption(wsConfig.getWsName(),
                newVersion);
        return new ScmConfEvent(ScmBusinessTypeDefine.WORKSPACE, EventType.UPDATE, notifycation);
    }
