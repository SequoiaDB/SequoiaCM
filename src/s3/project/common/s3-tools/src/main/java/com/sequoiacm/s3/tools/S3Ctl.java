...
import com.sequoiacm.s3.tools.command.ScmListToolImpl;
import com.sequoiacm.s3.tools.command.ScmStartToolImpl;
import com.sequoiacm.s3.tools.command.ScmStopToolImpl;
import com.sequoiacm.s3.tools.command.ScmTool;
import com.sequoiacm.s3.tools.common.ScmCommon;
import com.sequoiacm.s3.tools.common.ScmHelper;
...
public class S3Ctl {
    private static Logger logger = LoggerFactory.getLogger(S3Ctl.class.getName());
    public static String helpMsg = "usage: confctl <subcommand> [options] [args]" + "\r\n"
            + "Type 's3ctl help [subcommand]' for help on a specific subcommand" + "\r\n"
            + "Type 's3ctl --version' to see the program version" + "\r\n" + "\r\n"
    ...
    private static ScmTool getInstanceByToolName(String toolName) throws ScmToolsException {
        ...
        if (toolName.equals("start")) {
            ...
            instance = new ScmHelpToolImpl(S3Ctl.class, false);
        }
        else if (toolName.equals("helpfull")) {
            instance = new ScmHelpToolImpl(S3Ctl.class, true);
        }
        else {
            // TODO:
        }
