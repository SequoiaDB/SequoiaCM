...
public class ScmToolsDefine {
    ...
    public static class FILE_NAME {
        ...
        // jarName prefix
        public static final String S3_SERVER_JAR_NAME_PREFIX = "sequoiacm-s3-server-";
    ...
    public static class NODE_TYPE {
        public static final String S3_SERVER_NUM = "1";
        public static final String S3_SERVER_STR = FILE_NAME.S3_SERVER;
