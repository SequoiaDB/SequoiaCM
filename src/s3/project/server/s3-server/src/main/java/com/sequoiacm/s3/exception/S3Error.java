...
public enum S3Error {
    ...
    REGION_INIT_FAILED(-340, "RegionInitFailed", "Init workspace s3 custom meta failed."),

    // dao error
    SCM_CONTENSERER_NO_INSTANCE(-401, "NoContenServerInstance", "ContentServer instance not found."),
    SCM_CREATE_BREAKPOINT_FILE_FAILED(-402, "CreateBreakpointFileFailed", "Create scm breakpoint file failed."),
    SCM_CREATE_DIR_FAILED(-403, "CreateDirFailed", "Create scm dir failed."),
    SCM_DELETE_DIR_FAILED(-404, "DeleteDirFailed", "Delete scm dir failed."),
    SCM_GET_DIR_FAILED(-405, "GetDirFailed", "Get scm dir failed."),
    SCM_DOWNLOAD_FILE_FAILED(-406, "DownloadFileFailed", "Download scm file failed."),
    SCM_GET_FILE_FAILED(-407, "GetFileFailed", "Get scm file failed."),
    SCM_GET_META_FAILED(-408, "GetMetaFailed", "Get scm meta failed."),
    SCM_AUTH_FAILED(-409, "AuthFailed", "Failed to do auth in authserver"),
    SCM_DELETE_DIR_NOTEMPTY(-410, "DirNotEmpty", "Scm dir not empty."),
    SCM_GET_WS_FAILED(-411, "GetWorkspaceFailed", "Get scm workspace failed."),
    // bucket error
    ...
    OBJECT_INVALID_START_AFTER(-625, "InvalidStartAfter", "Start after contains invalid char"),
    ...
    REQUEST_TIME_TOO_SKEWED(-708, "RequestTimeTooSkewed", "The differcence between the request time and the server's time is too large."),
    ...
    METASOUCE_ERROR(-905, "MetaSourceError", "MetaSource Error.");
