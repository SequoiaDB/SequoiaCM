...
@Component
@ConfigurationProperties(prefix = "scm.s3.connection")
public class ScmConnectionConfig {
    ...
    private int siteInfoRefreshInterval = 30 * 1000;
    private int workspaceCacheTTL = 2 * 60 * 1000;

    public int getWorkspaceCacheTTL() {
        return workspaceCacheTTL;
    }

    public void setWorkspaceCacheTTL(int workspaceCacheTTL) {
        this.workspaceCacheTTL = workspaceCacheTTL;
    }
    ...
    public int getSiteInfoRefreshInterval() {
        return siteInfoRefreshInterval;
    }

    public void setSiteInfoRefreshInterval(int siteInfoRefreshInterval) {
        this.siteInfoRefreshInterval = siteInfoRefreshInterval;
    }
