...
import com.sequoiacm.fulltext.tools.command.ScmHelpToolImpl;
import com.sequoiacm.fulltext.tools.command.ScmListToolImpl;
import com.sequoiacm.fulltext.tools.command.ScmStartToolImpl;
import com.sequoiacm.fulltext.tools.command.ScmStopToolImpl;
import com.sequoiacm.fulltext.tools.command.ScmTool;
import com.sequoiacm.fulltext.tools.common.ScmCommon;
import com.sequoiacm.fulltext.tools.common.ScmHelper;
...
public class FulltextCtl {
    private static Logger logger = LoggerFactory.getLogger(FulltextCtl.class.getName());
    public static String helpMsg = "usage: mqctl <subcommand> [options] [args]" + "\r\n"
            + "Type 'ftctl help [subcommand]' for help on a specific subcommand" + "\r\n"
            + "Type 'ftctl --version' to see the program version" + "\r\n" + "\r\n"
    ...
    private static ScmTool getInstanceByToolName(String toolName) throws ScmToolsException {
        ...
        if (toolName.equals("start")) {
            ...
            instance = new ScmHelpToolImpl(FulltextCtl.class, false);
        }
        else if (toolName.equals("helpfull")) {
            instance = new ScmHelpToolImpl(FulltextCtl.class, true);
        }
        else {
        }
        return instance;
