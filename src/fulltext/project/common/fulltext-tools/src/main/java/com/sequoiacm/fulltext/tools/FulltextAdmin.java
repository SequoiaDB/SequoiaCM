...
import com.sequoiacm.fulltext.tools.command.ScmCreateNodeToolImpl;
...
public class FulltextAdmin {
    private static Logger logger = LoggerFactory.getLogger(FulltextAdmin.class.getName());
    public final static String helpMsg = "usage: mqadmin <subcommand> [options] [args]" + "\r\n"
            + "Type 'ftadmin help [subcommand]' for help on a specific subcommand" + "\r\n"
            + "Type 'ftadmin --version' to see the program version" + "\r\n"
    ...
    private static ScmTool getInstanceByToolName(String toolName) throws ScmToolsException {
        ...
        if (toolName.equals("createnode")) {
            ...
            instance = new ScmHelpToolImpl(FulltextAdmin.class, false);
        }
        else if (toolName.equals("helpfull")) {
            instance = new ScmHelpToolImpl(FulltextAdmin.class, true);
        }
        return instance;
    }
}
