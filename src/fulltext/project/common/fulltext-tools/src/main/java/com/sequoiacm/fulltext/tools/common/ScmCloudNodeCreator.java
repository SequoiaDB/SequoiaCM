...
import com.sequoiacm.fulltext.tools.exec.ScmExecutorWrapper;
...
public class ScmCloudNodeCreator {
    ...
    public ScmCloudNodeCreator(ScmNodeType type, Properties prop) {
        this.type = type;
        this.prop = prop;
    }
    ...
    private String loadDefaultPort() throws ScmToolsException {
        ...
        InputStream is = ScmCreateNodeToolImpl.class.getClassLoader().getResourceAsStream(
                resourcefile);
        if (is == null) {
    ...
    private void createConf(String sampleConf, String outputConfPath, Properties modifier)
        ...
        InputStream is = FulltextCtl.class.getClassLoader().getResourceAsStream(sampleConf);
        if (is == null) {
