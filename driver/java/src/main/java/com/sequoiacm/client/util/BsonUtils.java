...
public final class BsonUtils {
    ...
    private static <F> F getChecked(BSONObject object, String field) throws ScmException {
        F f = get(object, field);
        if (f == null) {
            throw new ScmInvalidArgumentException("missing field " + field);
        }
        return f;
    }
    ...
    public static Object getObjectChecked(BSONObject object, String field) throws ScmException {
    ...
    public static String getStringChecked(BSONObject object, String field) throws ScmException {
        return getChecked(object, field);
    }
    ...
    public static Number getNumberChecked(BSONObject object, String field) throws ScmException {
        return getChecked(object, field);
    }
    ...
    public static Long getLongChecked(BSONObject object, String field) throws ScmException {
        return getChecked(object, field);
    }
    ...
    public static Integer getIntegerChecked(BSONObject object, String field) throws ScmException {
        return getChecked(object, field);
    }
    ...
    public static Boolean getBooleanChecked(BSONObject object, String field) throws ScmException {
        return getChecked(object, field);
    }
